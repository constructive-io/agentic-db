-- Deploy: schemas/agentic_db_app_private/trigger_fns/events_search_tsv_tsv
-- made with <3 @ constructive.io

-- requires: schemas/agentic_db_app_private/schema


CREATE FUNCTION agentic_db_app_private.events_search_tsv_tsv() RETURNS TRIGGER AS $_PGFN_$
