-- Deploy: schemas/agentic_db_status_private/trigger_fns/tg_achv
...
CREATE FUNCTION agentic_db_status_private.tg_achv ()
  RETURNS TRIGGER
  AS $$
DECLARE
  is_null boolean;
...
LANGUAGE 'plpgsql'
VOLATILE;
GRANT EXECUTE ON FUNCTION agentic_db_status_private.tg_achv TO authenticated;
