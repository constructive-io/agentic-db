-- Deploy: schemas/agentic_db_status_private/trigger_fns/member_tg_achv_tgl
...
CREATE FUNCTION agentic_db_status_private.member_tg_achv_tgl() RETURNS TRIGGER AS $_PGFN_$
DECLARE
  is_null boolean;
  task_name text;
  entity_id uuid;
