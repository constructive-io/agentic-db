-- Deploy: schemas/agentic_db_limits_public/tables/org_limit_defaults/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON agentic_db_limits_public.org_limit_defaults
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
