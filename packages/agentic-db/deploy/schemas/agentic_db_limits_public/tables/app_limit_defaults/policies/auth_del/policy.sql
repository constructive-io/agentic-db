-- Deploy: schemas/agentic_db_limits_public/tables/app_limit_defaults/policies/auth_del/policy
...
CREATE POLICY auth_del ON agentic_db_limits_public.app_limit_defaults
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
