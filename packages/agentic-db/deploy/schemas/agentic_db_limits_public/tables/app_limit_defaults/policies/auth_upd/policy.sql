-- Deploy: schemas/agentic_db_limits_public/tables/app_limit_defaults/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON agentic_db_limits_public.app_limit_defaults
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
