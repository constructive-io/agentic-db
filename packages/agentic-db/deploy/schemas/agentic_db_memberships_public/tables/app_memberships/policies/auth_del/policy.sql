-- Deploy: schemas/agentic_db_memberships_public/tables/app_memberships/policies/auth_del/policy
...
CREATE POLICY auth_del ON agentic_db_memberships_public.app_memberships
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
