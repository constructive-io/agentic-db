-- Deploy: schemas/agentic_db_memberships_public/tables/app_grants/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agentic_db_memberships_public".app_grants
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
