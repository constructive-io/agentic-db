-- Deploy: schemas/agentic_db_memberships_public/tables/app_grants/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agentic_db_memberships_public".app_grants
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
