-- Deploy: schemas/agentic_db_memberships_public/tables/org_membership_defaults/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON agentic_db_memberships_public.org_membership_defaults
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
