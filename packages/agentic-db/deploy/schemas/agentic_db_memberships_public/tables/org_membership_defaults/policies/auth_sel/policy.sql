-- Deploy: schemas/agentic_db_memberships_public/tables/org_membership_defaults/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON agentic_db_memberships_public.org_membership_defaults
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
