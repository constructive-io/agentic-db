-- Deploy: schemas/agentic_db_memberships_public/tables/org_membership_defaults/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON agentic_db_memberships_public.org_membership_defaults
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
