-- Deploy: schemas/agentic_db_memberships_public/tables/org_grants/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON agentic_db_memberships_public.org_grants
FOR SELECT
TO authenticated
USING (
