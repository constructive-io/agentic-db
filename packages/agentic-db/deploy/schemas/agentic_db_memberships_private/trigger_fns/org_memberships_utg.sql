-- Deploy: schemas/agentic_db_memberships_private/trigger_fns/org_memberships_utg
-- made with <3 @ constructive.io

-- requires: schemas/agentic_db_memberships_private/schema


CREATE FUNCTION agentic_db_memberships_private.org_memberships_utg() RETURNS TRIGGER AS $_PGFN_$
DECLARE
