-- Deploy: schemas/agentic_db_memberships_private/trigger_fns/org_memberships_update_sprt_tg
...
CREATE FUNCTION agentic_db_memberships_private.org_memberships_update_sprt_tg() RETURNS TRIGGER AS $_PGFN_$
DECLARE
  v_num_updated int;
...
BEGIN
  ...
  ELSE
    SELECT
      EXISTS (SELECT 1
      FROM agentic_db_memberships_private.app_memberships_sprt
      WHERE
