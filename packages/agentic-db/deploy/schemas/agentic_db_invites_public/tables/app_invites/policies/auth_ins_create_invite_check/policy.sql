-- Deploy: schemas/agentic_db_invites_public/tables/app_invites/policies/auth_ins_create_invite_check/policy
...
CREATE POLICY auth_ins_create_invite_check ON agentic_db_invites_public.app_invites
AS RESTRICTIVE
FOR INSERT
TO authenticated
WITH CHECK (
