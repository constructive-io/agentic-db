-- Deploy: schemas/agentic_db_profiles_public/tables/org_profile_grants/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON agentic_db_profiles_public.org_profile_grants
FOR SELECT
TO authenticated
USING (
