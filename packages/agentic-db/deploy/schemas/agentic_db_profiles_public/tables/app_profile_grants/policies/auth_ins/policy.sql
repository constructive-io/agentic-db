-- Deploy: schemas/agentic_db_profiles_public/tables/app_profile_grants/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON agentic_db_profiles_public.app_profile_grants
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
