-- Deploy: schemas/agentic_db_profiles_public/tables/org_profiles/policies/auth_del/policy
...
CREATE POLICY auth_del ON agentic_db_profiles_public.org_profiles
FOR DELETE
TO authenticated
USING (
