-- Deploy: schemas/agentic_db_profiles_public/tables/org_profiles/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agentic_db_profiles_public".org_profiles
FOR INSERT
TO authenticated
WITH CHECK (
