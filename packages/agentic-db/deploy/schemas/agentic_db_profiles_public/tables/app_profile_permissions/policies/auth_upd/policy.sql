-- Deploy: schemas/agentic_db_profiles_public/tables/app_profile_permissions/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON agentic_db_profiles_public.app_profile_permissions
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
