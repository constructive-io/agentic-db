-- Deploy: schemas/agentic_db_profiles_public/tables/org_profile_permissions/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agentic_db_profiles_public".org_profile_permissions
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
