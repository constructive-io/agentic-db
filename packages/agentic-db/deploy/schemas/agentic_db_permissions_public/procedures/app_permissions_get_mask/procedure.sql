-- Deploy: schemas/agentic_db_permissions_public/procedures/app_permissions_get_mask/procedure
...
CREATE FUNCTION agentic_db_permissions_public.app_permissions_get_mask(
  ids uuid[]
