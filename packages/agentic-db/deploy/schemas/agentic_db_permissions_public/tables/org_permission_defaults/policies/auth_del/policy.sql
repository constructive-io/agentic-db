-- Deploy: schemas/agentic_db_permissions_public/tables/org_permission_defaults/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agentic_db_permissions_public".org_permission_defaults
FOR DELETE
TO authenticated
USING (
