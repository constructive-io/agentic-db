-- Deploy: schemas/agentic_db_permissions_public/tables/app_permissions/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agentic_db_permissions_public".app_permissions
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
