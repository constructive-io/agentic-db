-- Deploy: schemas/agentic_db_permissions_public/tables/app_permissions/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON agentic_db_permissions_public.app_permissions
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
