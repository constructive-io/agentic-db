-- Deploy: schemas/agentic_db_private/trigger_fns/code_chunks_embedding_stale
...
CREATE FUNCTION agentic_db_private.code_chunks_embedding_stale() RETURNS TRIGGER AS $_PGFN_$
BEGIN
