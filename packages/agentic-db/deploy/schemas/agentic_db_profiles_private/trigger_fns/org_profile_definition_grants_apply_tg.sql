-- Deploy: schemas/agentic_db_profiles_private/trigger_fns/org_profile_definition_grants_apply_tg
...
CREATE FUNCTION agentic_db_profiles_private.org_profile_definition_grants_apply_tg() RETURNS TRIGGER AS $_PGFN_$
BEGIN
  IF NEW.is_grant IS TRUE THEN
    INSERT INTO agentic_db_profiles_public.org_profile_permissions (
      profile_id,
      permission_id
    )
    VALUES
