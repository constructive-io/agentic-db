-- Deploy: schemas/agentic_db_users_public/tables/users/policies/auth_del_admin_deletes/policy
...
CREATE POLICY auth_del_admin_deletes ON agentic_db_users_public.users
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
