-- Deploy: schemas/agentic_db_user_identifiers_public/tables/email_notes/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_user_identifiers_public.email_notes TO authenticated;
