-- Deploy: schemas/agentic_db_user_identifiers_public/tables/email_notes/indexes/email_notes_entity_id_idx
...
CREATE INDEX email_notes_entity_id_idx ON agentic_db_user_identifiers_public.email_notes USING BTREE ( entity_id );
