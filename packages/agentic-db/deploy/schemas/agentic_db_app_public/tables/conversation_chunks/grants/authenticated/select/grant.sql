-- Deploy: schemas/agentic_db_app_public/tables/conversation_chunks/grants/authenticated/select/grant
...
GRANT SELECT ON "agentic_db_app_public".conversation_chunks TO authenticated;
