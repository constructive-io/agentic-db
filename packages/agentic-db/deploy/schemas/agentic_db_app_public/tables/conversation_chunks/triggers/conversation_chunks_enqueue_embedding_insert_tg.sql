-- Deploy: schemas/agentic_db_app_public/tables/conversation_chunks/triggers/conversation_chunks_enqueue_embedding_insert_tg
...
CREATE TRIGGER conversation_chunks_enqueue_embedding_insert_tg
AFTER INSERT ON "agentic_db_app_public".conversation_chunks
FOR EACH ROW
