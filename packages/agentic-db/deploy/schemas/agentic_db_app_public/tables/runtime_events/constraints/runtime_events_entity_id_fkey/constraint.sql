-- Deploy: schemas/agentic_db_app_public/tables/runtime_events/constraints/runtime_events_entity_id_fkey/constraint
...
ALTER TABLE agentic_db_app_public.runtime_events 
  ADD CONSTRAINT runtime_events_entity_id_fkey 
