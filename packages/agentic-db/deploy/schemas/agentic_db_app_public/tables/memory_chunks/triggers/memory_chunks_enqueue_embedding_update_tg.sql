-- Deploy: schemas/agentic_db_app_public/tables/memory_chunks/triggers/memory_chunks_enqueue_embedding_update_tg
...
CREATE TRIGGER memory_chunks_enqueue_embedding_update_tg
AFTER UPDATE ON "agentic_db_app_public".memory_chunks
FOR EACH ROW
