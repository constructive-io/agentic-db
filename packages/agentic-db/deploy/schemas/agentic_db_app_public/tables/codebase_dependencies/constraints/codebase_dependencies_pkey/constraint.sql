-- Deploy: schemas/agentic_db_app_public/tables/codebase_dependencies/constraints/codebase_dependencies_pkey/constraint
...
ALTER TABLE "agentic_db_app_public".codebase_dependencies 
  ADD CONSTRAINT codebase_dependencies_pkey PRIMARY KEY (id);
