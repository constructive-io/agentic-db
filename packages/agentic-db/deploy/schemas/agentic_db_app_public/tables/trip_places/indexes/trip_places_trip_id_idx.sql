-- Deploy: schemas/agentic_db_app_public/tables/trip_places/indexes/trip_places_trip_id_idx
...
CREATE INDEX trip_places_trip_id_idx ON "agentic_db_app_public".trip_places USING BTREE ( trip_id );
