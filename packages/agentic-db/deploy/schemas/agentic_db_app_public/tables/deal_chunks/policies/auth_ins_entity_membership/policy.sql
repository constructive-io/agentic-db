-- Deploy: schemas/agentic_db_app_public/tables/deal_chunks/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agentic_db_app_public".deal_chunks
FOR INSERT
TO authenticated
WITH CHECK (
