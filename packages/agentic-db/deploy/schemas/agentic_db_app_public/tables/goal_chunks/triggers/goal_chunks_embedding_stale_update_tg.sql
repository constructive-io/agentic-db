-- Deploy: schemas/agentic_db_app_public/tables/goal_chunks/triggers/goal_chunks_embedding_stale_update_tg
...
CREATE TRIGGER goal_chunks_embedding_stale_update_tg
BEFORE UPDATE ON "agentic_db_app_public".goal_chunks
FOR EACH ROW
