-- Deploy: schemas/agentic_db_app_public/tables/tool_executions/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON agentic_db_app_public.tool_executions
FOR INSERT
TO authenticated
WITH CHECK (
