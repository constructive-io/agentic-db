-- Deploy: schemas/agentic_db_app_public/tables/contact_notes/grants/authenticated/delete/grant
...
GRANT DELETE ON "agentic_db_app_public".contact_notes TO authenticated;
