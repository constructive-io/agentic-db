-- Deploy: schemas/agentic_db_app_public/tables/deal_contacts/indexes/deal_contacts_entity_id_idx
...
CREATE INDEX deal_contacts_entity_id_idx ON agentic_db_app_public.deal_contacts USING BTREE ( entity_id );
