-- Deploy: schemas/agentic_db_app_public/tables/autonomy_records_chunks/policies/auth_del_auth_del_entity_membership/policy
...
CREATE POLICY auth_del_auth_del_entity_membership ON "agentic_db_app_public".autonomy_records_chunks
FOR DELETE
TO authenticated
USING (
