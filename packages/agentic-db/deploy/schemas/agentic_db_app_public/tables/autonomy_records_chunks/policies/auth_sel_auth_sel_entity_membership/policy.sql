-- Deploy: schemas/agentic_db_app_public/tables/autonomy_records_chunks/policies/auth_sel_auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_auth_sel_entity_membership ON "agentic_db_app_public".autonomy_records_chunks
FOR SELECT
TO authenticated
USING (
