-- Deploy: schemas/agentic_db_app_public/tables/autonomy_records_chunks/indexes/autonomy_records_chunks_chunk_index_idx
...
CREATE INDEX autonomy_records_chunks_chunk_index_idx ON agentic_db_app_public.autonomy_records_chunks USING BTREE ( chunk_index );
