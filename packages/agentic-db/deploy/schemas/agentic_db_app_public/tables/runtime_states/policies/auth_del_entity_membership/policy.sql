-- Deploy: schemas/agentic_db_app_public/tables/runtime_states/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agentic_db_app_public.runtime_states
FOR DELETE
TO authenticated
USING (
