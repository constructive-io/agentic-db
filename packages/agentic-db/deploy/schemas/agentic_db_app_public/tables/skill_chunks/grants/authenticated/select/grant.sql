-- Deploy: schemas/agentic_db_app_public/tables/skill_chunks/grants/authenticated/select/grant
...
GRANT SELECT ON "agentic_db_app_public".skill_chunks TO authenticated;
