...
-- requires: schemas/agentic_db_app_private/trigger_fns/touchpoints_enqueue_embedding
...
EXECUTE PROCEDURE agentic_db_app_private.touchpoints_enqueue_embedding ( );
