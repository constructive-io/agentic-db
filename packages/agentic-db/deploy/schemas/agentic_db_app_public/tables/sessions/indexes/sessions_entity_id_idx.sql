-- Deploy: schemas/agentic_db_app_public/tables/sessions/indexes/sessions_entity_id_idx
...
CREATE INDEX sessions_entity_id_idx ON "agentic_db_app_public".sessions USING BTREE ( entity_id );
