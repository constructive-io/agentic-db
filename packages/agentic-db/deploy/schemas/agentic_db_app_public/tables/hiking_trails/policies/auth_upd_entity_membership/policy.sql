-- Deploy: schemas/agentic_db_app_public/tables/hiking_trails/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON agentic_db_app_public.hiking_trails
FOR UPDATE
TO authenticated
USING (
