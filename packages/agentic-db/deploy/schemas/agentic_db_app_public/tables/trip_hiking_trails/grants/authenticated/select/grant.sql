-- Deploy: schemas/agentic_db_app_public/tables/trip_hiking_trails/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.trip_hiking_trails TO authenticated;
