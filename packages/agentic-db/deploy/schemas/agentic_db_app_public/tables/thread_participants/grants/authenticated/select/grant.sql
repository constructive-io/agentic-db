-- Deploy: schemas/agentic_db_app_public/tables/thread_participants/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.thread_participants TO authenticated;
