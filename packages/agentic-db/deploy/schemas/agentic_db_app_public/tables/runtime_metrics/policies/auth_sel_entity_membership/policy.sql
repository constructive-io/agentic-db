-- Deploy: schemas/agentic_db_app_public/tables/runtime_metrics/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agentic_db_app_public.runtime_metrics
FOR SELECT
TO authenticated
USING (
