-- Deploy: schemas/agentic_db_app_public/tables/goal_habits/indexes/goal_habits_goal_id_idx
...
CREATE INDEX goal_habits_goal_id_idx ON agentic_db_app_public.goal_habits USING BTREE ( goal_id );
