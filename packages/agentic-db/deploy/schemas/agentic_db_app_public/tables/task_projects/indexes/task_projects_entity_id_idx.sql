-- Deploy: schemas/agentic_db_app_public/tables/task_projects/indexes/task_projects_entity_id_idx
...
CREATE INDEX task_projects_entity_id_idx ON "agentic_db_app_public".task_projects USING BTREE ( entity_id );
