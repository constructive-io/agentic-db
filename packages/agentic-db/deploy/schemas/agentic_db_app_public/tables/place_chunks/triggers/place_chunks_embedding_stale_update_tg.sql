-- Deploy: schemas/agentic_db_app_public/tables/place_chunks/triggers/place_chunks_embedding_stale_update_tg
...
CREATE TRIGGER place_chunks_embedding_stale_update_tg
BEFORE UPDATE ON "agentic_db_app_public".place_chunks
FOR EACH ROW
