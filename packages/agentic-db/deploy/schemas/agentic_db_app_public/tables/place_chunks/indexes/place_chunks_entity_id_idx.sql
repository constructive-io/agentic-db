-- Deploy: schemas/agentic_db_app_public/tables/place_chunks/indexes/place_chunks_entity_id_idx
...
CREATE INDEX place_chunks_entity_id_idx ON "agentic_db_app_public".place_chunks USING BTREE ( entity_id );
