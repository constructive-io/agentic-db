-- Deploy: schemas/agentic_db_app_public/tables/deal_companies/constraints/deal_companies_deal_id_fkey/constraint
...
ALTER TABLE agentic_db_app_public.deal_companies 
  ADD CONSTRAINT deal_companies_deal_id_fkey 
    FOREIGN KEY(deal_id) 
