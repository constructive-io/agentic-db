-- Deploy: schemas/agentic_db_app_public/tables/agent_skills/indexes/agent_skills_entity_id_idx
...
CREATE INDEX agent_skills_entity_id_idx ON "agentic_db_app_public".agent_skills USING BTREE ( entity_id );
