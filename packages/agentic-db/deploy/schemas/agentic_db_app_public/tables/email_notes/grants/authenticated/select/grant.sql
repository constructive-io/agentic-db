-- Deploy: schemas/agentic_db_app_public/tables/email_notes/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.email_notes TO authenticated;
