-- Deploy: schemas/agentic_db_app_public/tables/email_notes/grants/authenticated/delete/grant
...
GRANT DELETE ON "agentic_db_app_public".email_notes TO authenticated;
