-- Deploy: schemas/agentic_db_app_public/tables/email_notes/indexes/email_notes_email_id_idx
...
CREATE INDEX email_notes_email_id_idx ON agentic_db_app_public.email_notes USING BTREE ( email_id );
