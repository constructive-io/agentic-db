...
-- requires: schemas/agentic_db_app_private/trigger_fns/calendar_events_search_tsv_tsv
...
EXECUTE PROCEDURE agentic_db_app_private.calendar_events_search_tsv_tsv ( );
