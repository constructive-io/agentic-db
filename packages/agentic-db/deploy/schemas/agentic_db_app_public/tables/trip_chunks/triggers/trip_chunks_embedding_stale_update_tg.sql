-- Deploy: schemas/agentic_db_app_public/tables/trip_chunks/triggers/trip_chunks_embedding_stale_update_tg
...
CREATE TRIGGER trip_chunks_embedding_stale_update_tg
BEFORE UPDATE ON "agentic_db_app_public".trip_chunks
FOR EACH ROW
