-- Deploy: schemas/agentic_db_app_public/tables/runtime_states_chunks/indexes/runtime_states_chunks_runtime_state_id_idx
...
CREATE INDEX runtime_states_chunks_runtime_state_id_idx ON agentic_db_app_public.runtime_states_chunks USING BTREE ( runtime_state_id );
