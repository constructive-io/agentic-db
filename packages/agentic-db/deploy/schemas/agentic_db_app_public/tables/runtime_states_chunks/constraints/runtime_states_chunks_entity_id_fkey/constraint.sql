-- Deploy: schemas/agentic_db_app_public/tables/runtime_states_chunks/constraints/runtime_states_chunks_entity_id_fkey/constraint
...
ALTER TABLE agentic_db_app_public.runtime_states_chunks 
  ADD CONSTRAINT runtime_states_chunks_entity_id_fkey 
