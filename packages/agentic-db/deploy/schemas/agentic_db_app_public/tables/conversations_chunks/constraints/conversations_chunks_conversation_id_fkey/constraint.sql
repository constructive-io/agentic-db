-- Deploy: schemas/agentic_db_app_public/tables/conversations_chunks/constraints/conversations_chunks_conversation_id_fkey/constraint
...
ALTER TABLE agentic_db_app_public.conversations_chunks 
  ADD CONSTRAINT conversations_chunks_conversation_id_fkey 
