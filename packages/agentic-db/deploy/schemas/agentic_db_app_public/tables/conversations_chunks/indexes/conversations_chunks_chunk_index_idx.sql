-- Deploy: schemas/agentic_db_app_public/tables/conversations_chunks/indexes/conversations_chunks_chunk_index_idx
...
CREATE INDEX conversations_chunks_chunk_index_idx ON agentic_db_app_public.conversations_chunks USING BTREE ( chunk_index );
