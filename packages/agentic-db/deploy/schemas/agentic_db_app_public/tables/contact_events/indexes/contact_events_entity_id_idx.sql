-- Deploy: schemas/agentic_db_app_public/tables/contact_events/indexes/contact_events_entity_id_idx
...
CREATE INDEX contact_events_entity_id_idx ON "agentic_db_app_public".contact_events USING BTREE ( entity_id );
