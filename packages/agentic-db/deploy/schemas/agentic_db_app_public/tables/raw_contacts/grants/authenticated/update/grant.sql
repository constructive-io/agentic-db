-- Deploy: schemas/agentic_db_app_public/tables/raw_contacts/grants/authenticated/update/grant
...
GRANT UPDATE ON "agentic_db_app_public".raw_contacts TO authenticated;
