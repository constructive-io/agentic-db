-- Deploy: schemas/agentic_db_app_public/tables/raw_contacts/grants/authenticated/select/grant
...
GRANT SELECT ON "agentic_db_app_public".raw_contacts TO authenticated;
