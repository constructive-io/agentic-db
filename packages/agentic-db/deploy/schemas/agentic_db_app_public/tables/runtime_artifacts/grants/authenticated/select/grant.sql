-- Deploy: schemas/agentic_db_app_public/tables/runtime_artifacts/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.runtime_artifacts TO authenticated;
