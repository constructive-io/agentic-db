...
-- requires: schemas/agentic_db_app_private/trigger_fns/interactions_enqueue_embedding
...
EXECUTE PROCEDURE agentic_db_app_private.interactions_enqueue_embedding ( );
