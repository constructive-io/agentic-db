-- Deploy: schemas/agentic_db_app_public/tables/expense_contacts/indexes/expense_contacts_entity_id_idx
...
CREATE INDEX expense_contacts_entity_id_idx ON "agentic_db_app_public".expense_contacts USING BTREE ( entity_id );
