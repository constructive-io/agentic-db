-- Deploy: schemas/agentic_db_app_public/tables/expense_contacts/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.expense_contacts TO authenticated;
