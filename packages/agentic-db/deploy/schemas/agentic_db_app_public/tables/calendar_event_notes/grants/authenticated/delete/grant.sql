-- Deploy: schemas/agentic_db_app_public/tables/calendar_event_notes/grants/authenticated/delete/grant
...
GRANT DELETE ON agentic_db_app_public.calendar_event_notes TO authenticated;
