-- Deploy: schemas/agentic_db_app_public/tables/autonomy_record_chunks/triggers/autonomy_record_chunks_embedding_stale_update_tg
...
CREATE TRIGGER autonomy_record_chunks_embedding_stale_update_tg
BEFORE UPDATE ON "agentic_db_app_public".autonomy_record_chunks
FOR EACH ROW
