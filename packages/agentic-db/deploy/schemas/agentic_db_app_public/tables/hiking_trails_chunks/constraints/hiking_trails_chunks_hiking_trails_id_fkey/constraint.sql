-- Deploy: schemas/agentic_db_app_public/tables/hiking_trails_chunks/constraints/hiking_trails_chunks_hiking_trails_id_fkey/constraint
...
ALTER TABLE "agentic_db_app_public".hiking_trails_chunks 
  ADD CONSTRAINT hiking_trails_chunks_hiking_trails_id_fkey 
    FOREIGN KEY(hiking_trails_id) 
