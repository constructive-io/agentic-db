-- Deploy: schemas/agentic_db_app_public/tables/runtime_logs/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON agentic_db_app_public.runtime_logs
FOR INSERT
TO authenticated
WITH CHECK (
