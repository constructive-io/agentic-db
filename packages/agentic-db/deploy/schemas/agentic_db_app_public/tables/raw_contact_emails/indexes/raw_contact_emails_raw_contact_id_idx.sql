-- Deploy: schemas/agentic_db_app_public/tables/raw_contact_emails/indexes/raw_contact_emails_raw_contact_id_idx
...
CREATE INDEX raw_contact_emails_raw_contact_id_idx ON agentic_db_app_public.raw_contact_emails USING BTREE ( raw_contact_id );
