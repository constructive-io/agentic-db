-- Deploy: schemas/agentic_db_app_public/tables/raw_contact_emails/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.raw_contact_emails TO authenticated;
