-- Deploy: schemas/agentic_db_app_public/tables/tool_chunks/indexes/tool_chunks_tool_id_idx
...
CREATE INDEX tool_chunks_tool_id_idx ON agentic_db_app_public.tool_chunks USING BTREE ( tool_id );
