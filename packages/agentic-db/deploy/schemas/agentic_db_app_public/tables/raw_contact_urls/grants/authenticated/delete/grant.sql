-- Deploy: schemas/agentic_db_app_public/tables/raw_contact_urls/grants/authenticated/delete/grant
...
GRANT DELETE ON "agentic_db_app_public".raw_contact_urls TO authenticated;
