-- Deploy: schemas/agentic_db_app_public/tables/raw_contact_urls/grants/authenticated/update/grant
...
GRANT UPDATE ON agentic_db_app_public.raw_contact_urls TO authenticated;
