-- Deploy: schemas/agentic_db_app_public/tables/runtime_logs_chunks/constraints/runtime_logs_chunks_entity_id_fkey/constraint
...
ALTER TABLE agentic_db_app_public.runtime_logs_chunks 
  ADD CONSTRAINT runtime_logs_chunks_entity_id_fkey 
