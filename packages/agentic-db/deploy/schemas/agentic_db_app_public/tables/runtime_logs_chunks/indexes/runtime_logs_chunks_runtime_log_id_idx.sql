-- Deploy: schemas/agentic_db_app_public/tables/runtime_logs_chunks/indexes/runtime_logs_chunks_runtime_log_id_idx
...
CREATE INDEX runtime_logs_chunks_runtime_log_id_idx ON agentic_db_app_public.runtime_logs_chunks USING BTREE ( runtime_log_id );
