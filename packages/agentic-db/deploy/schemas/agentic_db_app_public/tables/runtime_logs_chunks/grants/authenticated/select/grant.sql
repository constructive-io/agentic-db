-- Deploy: schemas/agentic_db_app_public/tables/runtime_logs_chunks/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.runtime_logs_chunks TO authenticated;
