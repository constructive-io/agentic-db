-- Deploy: schemas/agentic_db_app_public/tables/email_accounts/indexes/email_accounts_entity_id_idx
...
CREATE INDEX email_accounts_entity_id_idx ON agentic_db_app_public.email_accounts USING BTREE ( entity_id );
