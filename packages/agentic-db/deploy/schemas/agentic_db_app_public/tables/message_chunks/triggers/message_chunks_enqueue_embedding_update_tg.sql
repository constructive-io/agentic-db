-- Deploy: schemas/agentic_db_app_public/tables/message_chunks/triggers/message_chunks_enqueue_embedding_update_tg
...
CREATE TRIGGER message_chunks_enqueue_embedding_update_tg
AFTER UPDATE ON "agentic_db_app_public".message_chunks
FOR EACH ROW
