...
-- requires: schemas/agentic_db_app_private/trigger_fns/autonomy_records_embedding_stale


CREATE TRIGGER autonomy_records_embedding_stale_insert_tg
BEFORE INSERT ON agentic_db_app_public.autonomy_records
FOR EACH ROW
EXECUTE PROCEDURE agentic_db_app_private.autonomy_records_embedding_stale ( );
