-- Deploy: schemas/agentic_db_app_public/tables/company_images/indexes/company_images_entity_id_idx
...
CREATE INDEX company_images_entity_id_idx ON agentic_db_app_public.company_images USING BTREE ( entity_id );
