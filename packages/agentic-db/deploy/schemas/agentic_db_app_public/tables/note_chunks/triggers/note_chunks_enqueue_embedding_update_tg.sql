-- Deploy: schemas/agentic_db_app_public/tables/note_chunks/triggers/note_chunks_enqueue_embedding_update_tg
...
CREATE TRIGGER note_chunks_enqueue_embedding_update_tg
AFTER UPDATE ON "agentic_db_app_public".note_chunks
FOR EACH ROW
