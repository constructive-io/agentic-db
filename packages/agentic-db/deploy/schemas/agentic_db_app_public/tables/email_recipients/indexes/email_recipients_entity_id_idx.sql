-- Deploy: schemas/agentic_db_app_public/tables/email_recipients/indexes/email_recipients_entity_id_idx
...
CREATE INDEX email_recipients_entity_id_idx ON agentic_db_app_public.email_recipients USING BTREE ( entity_id );
