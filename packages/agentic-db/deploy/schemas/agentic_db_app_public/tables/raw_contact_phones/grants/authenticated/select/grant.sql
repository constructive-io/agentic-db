-- Deploy: schemas/agentic_db_app_public/tables/raw_contact_phones/grants/authenticated/select/grant
...
GRANT SELECT ON "agentic_db_app_public".raw_contact_phones TO authenticated;
