-- Deploy: schemas/agentic_db_app_public/tables/project_chunks/triggers/project_chunks_enqueue_embedding_insert_tg
...
CREATE TRIGGER project_chunks_enqueue_embedding_insert_tg
AFTER INSERT ON "agentic_db_app_public".project_chunks
FOR EACH ROW
