-- Deploy: schemas/agentic_db_app_public/tables/project_chunks/triggers/project_chunks_embedding_stale_insert_tg
...
CREATE TRIGGER project_chunks_embedding_stale_insert_tg
BEFORE INSERT ON "agentic_db_app_public".project_chunks
FOR EACH ROW
