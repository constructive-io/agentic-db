-- Deploy: schemas/agentic_db_app_public/tables/runtime_state_chunks/triggers/runtime_state_chunks_enqueue_embedding_insert_tg
...
CREATE TRIGGER runtime_state_chunks_enqueue_embedding_insert_tg
AFTER INSERT ON "agentic_db_app_public".runtime_state_chunks
FOR EACH ROW
