-- Deploy: schemas/agentic_db_app_public/tables/conversations/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agentic_db_app_public".conversations
FOR DELETE
TO authenticated
USING (
