-- Deploy: schemas/agentic_db_app_public/tables/conversations/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agentic_db_app_public".conversations
FOR INSERT
TO authenticated
WITH CHECK (
