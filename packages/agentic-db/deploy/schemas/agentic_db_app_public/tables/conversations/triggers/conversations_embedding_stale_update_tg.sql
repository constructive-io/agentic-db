...
-- requires: schemas/agentic_db_app_private/trigger_fns/conversations_embedding_stale
...
EXECUTE PROCEDURE agentic_db_app_private.conversations_embedding_stale ( );
