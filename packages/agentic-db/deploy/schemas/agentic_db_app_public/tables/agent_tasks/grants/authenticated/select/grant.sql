-- Deploy: schemas/agentic_db_app_public/tables/agent_tasks/grants/authenticated/select/grant
...
GRANT SELECT ON "agentic_db_app_public".agent_tasks TO authenticated;
