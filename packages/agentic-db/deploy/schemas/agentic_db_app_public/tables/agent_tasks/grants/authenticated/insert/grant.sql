-- Deploy: schemas/agentic_db_app_public/tables/agent_tasks/grants/authenticated/insert/grant
...
GRANT INSERT ON "agentic_db_app_public".agent_tasks TO authenticated;
