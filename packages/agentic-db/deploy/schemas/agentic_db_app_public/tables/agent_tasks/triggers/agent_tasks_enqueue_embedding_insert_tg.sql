-- Deploy: schemas/agentic_db_app_public/tables/agent_tasks/triggers/agent_tasks_enqueue_embedding_insert_tg
...
CREATE TRIGGER agent_tasks_enqueue_embedding_insert_tg
