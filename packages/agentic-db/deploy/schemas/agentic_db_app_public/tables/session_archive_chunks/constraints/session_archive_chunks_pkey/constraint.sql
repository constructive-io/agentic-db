-- Deploy: schemas/agentic_db_app_public/tables/session_archive_chunks/constraints/session_archive_chunks_pkey/constraint
...
ALTER TABLE "agentic_db_app_public".session_archive_chunks 
  ADD CONSTRAINT session_archive_chunks_pkey PRIMARY KEY (id);
