-- Deploy: schemas/agentic_db_app_public/tables/repository_chunks/constraints/repository_chunks_pkey/constraint
...
ALTER TABLE agentic_db_app_public.repository_chunks 
  ADD CONSTRAINT repository_chunks_pkey PRIMARY KEY (id);
