-- Deploy: schemas/agentic_db_app_public/tables/agent_tools/indexes/agent_tools_entity_id_idx
...
CREATE INDEX agent_tools_entity_id_idx ON "agentic_db_app_public".agent_tools USING BTREE ( entity_id );
