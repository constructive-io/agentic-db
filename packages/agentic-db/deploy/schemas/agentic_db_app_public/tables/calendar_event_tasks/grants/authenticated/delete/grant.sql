-- Deploy: schemas/agentic_db_app_public/tables/calendar_event_tasks/grants/authenticated/delete/grant
...
GRANT DELETE ON agentic_db_app_public.calendar_event_tasks TO authenticated;
