-- Deploy: schemas/agentic_db_app_public/tables/codebases_chunks/indexes/codebases_chunks_chunk_index_idx
...
CREATE INDEX codebases_chunks_chunk_index_idx ON agentic_db_app_public.codebases_chunks USING BTREE ( chunk_index );
