-- Deploy: schemas/agentic_db_app_public/tables/runtime_config/grants/authenticated/delete/grant
...
GRANT DELETE ON agentic_db_app_public.runtime_config TO authenticated;
