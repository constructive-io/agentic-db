-- Deploy: schemas/agentic_db_app_public/tables/runtime_config/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON agentic_db_app_public.runtime_config
FOR UPDATE
TO authenticated
USING (
