-- Deploy: schemas/agentic_db_app_public/tables/hiking_trail_chunks/grants/authenticated/select/grant
...
GRANT SELECT ON "agentic_db_app_public".hiking_trail_chunks TO authenticated;
