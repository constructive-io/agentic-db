-- Deploy: schemas/agentic_db_app_public/tables/hiking_trail_chunks/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agentic_db_app_public.hiking_trail_chunks
FOR SELECT
TO authenticated
USING (
