-- Deploy: schemas/agentic_db_app_public/tables/autonomy_record_links/constraints/autonomy_record_links_pkey/constraint
...
ALTER TABLE "agentic_db_app_public".autonomy_record_links 
  ADD CONSTRAINT autonomy_record_links_pkey PRIMARY KEY (id);
