-- Deploy: schemas/agentic_db_app_public/tables/contacts_chunks/constraints/contacts_chunks_contact_id_fkey/constraint
...
ALTER TABLE agentic_db_app_public.contacts_chunks 
  ADD CONSTRAINT contacts_chunks_contact_id_fkey 
