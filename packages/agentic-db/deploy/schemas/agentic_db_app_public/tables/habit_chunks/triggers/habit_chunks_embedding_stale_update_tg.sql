-- Deploy: schemas/agentic_db_app_public/tables/habit_chunks/triggers/habit_chunks_embedding_stale_update_tg
...
CREATE TRIGGER habit_chunks_embedding_stale_update_tg
BEFORE UPDATE ON "agentic_db_app_public".habit_chunks
FOR EACH ROW
