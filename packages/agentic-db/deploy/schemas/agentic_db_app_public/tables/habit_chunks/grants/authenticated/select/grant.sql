-- Deploy: schemas/agentic_db_app_public/tables/habit_chunks/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.habit_chunks TO authenticated;
