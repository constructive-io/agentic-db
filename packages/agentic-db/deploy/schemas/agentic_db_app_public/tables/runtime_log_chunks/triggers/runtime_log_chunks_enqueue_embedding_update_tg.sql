-- Deploy: schemas/agentic_db_app_public/tables/runtime_log_chunks/triggers/runtime_log_chunks_enqueue_embedding_update_tg
...
CREATE TRIGGER runtime_log_chunks_enqueue_embedding_update_tg
AFTER UPDATE ON agentic_db_app_public.runtime_log_chunks
FOR EACH ROW
