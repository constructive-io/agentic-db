-- Deploy: schemas/agentic_db_app_public/tables/runtime_log_chunks/grants/authenticated/delete/grant
...
GRANT DELETE ON "agentic_db_app_public".runtime_log_chunks TO authenticated;
