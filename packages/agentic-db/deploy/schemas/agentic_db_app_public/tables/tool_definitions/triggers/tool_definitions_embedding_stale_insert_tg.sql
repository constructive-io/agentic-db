...
-- requires: schemas/agentic_db_app_private/trigger_fns/tool_definitions_embedding_stale


CREATE TRIGGER tool_definitions_embedding_stale_insert_tg
BEFORE INSERT ON agentic_db_app_public.tool_definitions
FOR EACH ROW
EXECUTE PROCEDURE agentic_db_app_private.tool_definitions_embedding_stale ( );
