-- Deploy: schemas/agentic_db_app_public/tables/chat_chunks/indexes/chat_chunks_entity_id_idx
...
CREATE INDEX chat_chunks_entity_id_idx ON "agentic_db_app_public".chat_chunks USING BTREE ( entity_id );
