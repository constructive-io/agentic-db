-- Deploy: schemas/agentic_db_app_public/tables/chat_messages/indexes/chat_messages_entity_id_idx
...
CREATE INDEX chat_messages_entity_id_idx ON "agentic_db_app_public".chat_messages USING BTREE ( entity_id );
