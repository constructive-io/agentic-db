-- Deploy: schemas/agentic_db_app_public/tables/task_notes/indexes/task_notes_task_id_idx
...
CREATE INDEX task_notes_task_id_idx ON "agentic_db_app_public".task_notes USING BTREE ( task_id );
