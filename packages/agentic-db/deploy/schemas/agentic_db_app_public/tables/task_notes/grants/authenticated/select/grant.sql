-- Deploy: schemas/agentic_db_app_public/tables/task_notes/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.task_notes TO authenticated;
