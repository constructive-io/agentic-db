-- Deploy: schemas/agentic_db_app_public/tables/agent_log_chunks/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON "agentic_db_app_public".agent_log_chunks
FOR UPDATE
TO authenticated
USING (
