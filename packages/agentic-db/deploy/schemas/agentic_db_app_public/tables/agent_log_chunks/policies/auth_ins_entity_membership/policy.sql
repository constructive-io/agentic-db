-- Deploy: schemas/agentic_db_app_public/tables/agent_log_chunks/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agentic_db_app_public".agent_log_chunks
FOR INSERT
TO authenticated
WITH CHECK (
