-- Deploy: schemas/agentic_db_app_public/tables/agent_log_chunks/triggers/agent_log_chunks_embedding_stale_update_tg
...
CREATE TRIGGER agent_log_chunks_embedding_stale_update_tg
BEFORE UPDATE ON "agentic_db_app_public".agent_log_chunks
FOR EACH ROW
