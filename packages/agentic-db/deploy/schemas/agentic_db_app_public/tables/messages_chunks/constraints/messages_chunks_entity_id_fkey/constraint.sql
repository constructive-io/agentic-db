-- Deploy: schemas/agentic_db_app_public/tables/messages_chunks/constraints/messages_chunks_entity_id_fkey/constraint
...
ALTER TABLE agentic_db_app_public.messages_chunks 
  ADD CONSTRAINT messages_chunks_entity_id_fkey 
