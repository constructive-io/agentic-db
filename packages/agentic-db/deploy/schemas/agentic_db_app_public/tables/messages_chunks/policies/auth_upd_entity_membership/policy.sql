-- Deploy: schemas/agentic_db_app_public/tables/messages_chunks/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON agentic_db_app_public.messages_chunks
FOR UPDATE
TO authenticated
USING (
