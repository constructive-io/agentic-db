-- Deploy: schemas/agentic_db_app_public/tables/messages_chunks/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agentic_db_app_public.messages_chunks
FOR DELETE
TO authenticated
USING (
