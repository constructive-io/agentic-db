-- Deploy: schemas/agentic_db_app_public/tables/deal_notes/indexes/deal_notes_note_id_idx
...
CREATE INDEX deal_notes_note_id_idx ON agentic_db_app_public.deal_notes USING BTREE ( note_id );
