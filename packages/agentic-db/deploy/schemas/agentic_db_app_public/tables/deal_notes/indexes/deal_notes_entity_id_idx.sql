-- Deploy: schemas/agentic_db_app_public/tables/deal_notes/indexes/deal_notes_entity_id_idx
...
CREATE INDEX deal_notes_entity_id_idx ON "agentic_db_app_public".deal_notes USING BTREE ( entity_id );
