-- Deploy: schemas/agentic_db_app_public/tables/deal_notes/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.deal_notes TO authenticated;
