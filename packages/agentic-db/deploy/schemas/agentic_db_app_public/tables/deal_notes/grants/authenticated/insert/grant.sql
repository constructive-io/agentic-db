-- Deploy: schemas/agentic_db_app_public/tables/deal_notes/grants/authenticated/insert/grant
...
GRANT INSERT ON agentic_db_app_public.deal_notes TO authenticated;
