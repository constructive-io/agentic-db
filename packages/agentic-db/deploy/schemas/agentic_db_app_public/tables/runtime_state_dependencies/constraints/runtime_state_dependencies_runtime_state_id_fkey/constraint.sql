-- Deploy: schemas/agentic_db_app_public/tables/runtime_state_dependencies/constraints/runtime_state_dependencies_runtime_state_id_fkey/constraint
...
ALTER TABLE agentic_db_app_public.runtime_state_dependencies 
  ADD CONSTRAINT runtime_state_dependencies_runtime_state_id_fkey 
