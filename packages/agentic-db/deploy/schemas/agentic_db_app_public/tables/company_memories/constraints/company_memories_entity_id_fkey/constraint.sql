-- Deploy: schemas/agentic_db_app_public/tables/company_memories/constraints/company_memories_entity_id_fkey/constraint
...
ALTER TABLE agentic_db_app_public.company_memories 
  ADD CONSTRAINT company_memories_entity_id_fkey 
