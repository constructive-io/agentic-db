-- Deploy: schemas/agentic_db_app_public/tables/company_chunks/indexes/company_chunks_entity_id_idx
...
CREATE INDEX company_chunks_entity_id_idx ON agentic_db_app_public.company_chunks USING BTREE ( entity_id );
