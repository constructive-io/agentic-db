-- Deploy: schemas/agentic_db_app_public/tables/tags/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON agentic_db_app_public.tags
FOR UPDATE
TO authenticated
USING (
