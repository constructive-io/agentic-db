-- Deploy: schemas/agentic_db_app_public/tables/company_notes/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.company_notes TO authenticated;
