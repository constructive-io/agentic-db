-- Deploy: schemas/agentic_db_app_public/tables/company_notes/grants/authenticated/delete/grant
...
GRANT DELETE ON agentic_db_app_public.company_notes TO authenticated;
