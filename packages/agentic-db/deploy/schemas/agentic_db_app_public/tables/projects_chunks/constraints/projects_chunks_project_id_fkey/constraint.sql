-- Deploy: schemas/agentic_db_app_public/tables/projects_chunks/constraints/projects_chunks_project_id_fkey/constraint
...
ALTER TABLE agentic_db_app_public.projects_chunks 
  ADD CONSTRAINT projects_chunks_project_id_fkey 
