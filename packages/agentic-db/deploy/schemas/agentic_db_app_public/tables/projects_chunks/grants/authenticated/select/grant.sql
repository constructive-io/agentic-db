-- Deploy: schemas/agentic_db_app_public/tables/projects_chunks/grants/authenticated/select/grant
...
GRANT SELECT ON "agentic_db_app_public".projects_chunks TO authenticated;
