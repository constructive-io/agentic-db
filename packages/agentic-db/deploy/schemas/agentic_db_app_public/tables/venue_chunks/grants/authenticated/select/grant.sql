-- Deploy: schemas/agentic_db_app_public/tables/venue_chunks/grants/authenticated/select/grant
...
GRANT SELECT ON agentic_db_app_public.venue_chunks TO authenticated;
