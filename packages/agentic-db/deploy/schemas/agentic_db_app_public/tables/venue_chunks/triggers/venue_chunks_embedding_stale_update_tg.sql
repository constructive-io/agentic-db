-- Deploy: schemas/agentic_db_app_public/tables/venue_chunks/triggers/venue_chunks_embedding_stale_update_tg
...
CREATE TRIGGER venue_chunks_embedding_stale_update_tg
BEFORE UPDATE ON "agentic_db_app_public".venue_chunks
FOR EACH ROW
