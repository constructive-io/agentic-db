-- Deploy: schemas/agentic_db_app_public/tables/task_chunks/indexes/task_chunks_entity_id_idx
...
CREATE INDEX task_chunks_entity_id_idx ON agentic_db_app_public.task_chunks USING BTREE ( entity_id );
