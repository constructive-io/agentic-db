-- Deploy: schemas/agentic_db_permissions_private/trigger_fns/app_permissions_bitnum_tg
-- made with <3 @ constructive.io

-- requires: schemas/agentic_db_permissions_private/schema


CREATE FUNCTION agentic_db_permissions_private.app_permissions_bitnum_tg() RETURNS TRIGGER AS $_PGFN_$
DECLARE
