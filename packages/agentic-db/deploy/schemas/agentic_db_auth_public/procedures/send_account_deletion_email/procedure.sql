...
CREATE FUNCTION agentic_db_auth_public.send_account_deletion_email ()
    RETURNS boolean
AS $$
DECLARE
...
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION agentic_db_auth_public.send_account_deletion_email TO authenticated;
