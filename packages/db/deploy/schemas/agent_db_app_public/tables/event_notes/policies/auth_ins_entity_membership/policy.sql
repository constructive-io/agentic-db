-- Deploy: schemas/agent_db_app_public/tables/event_notes/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".event_notes
FOR INSERT
TO authenticated
WITH CHECK (
