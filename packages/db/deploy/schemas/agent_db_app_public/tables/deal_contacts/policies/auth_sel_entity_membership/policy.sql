-- Deploy: schemas/agent_db_app_public/tables/deal_contacts/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent_db_app_public".deal_contacts
FOR SELECT
TO authenticated
USING (
