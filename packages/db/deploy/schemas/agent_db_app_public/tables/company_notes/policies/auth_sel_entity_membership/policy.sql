-- Deploy: schemas/agent_db_app_public/tables/company_notes/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent_db_app_public".company_notes
FOR SELECT
TO authenticated
USING (
