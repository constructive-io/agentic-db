-- Deploy: schemas/agent_db_app_public/tables/workflow_steps/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".workflow_steps
FOR DELETE
TO authenticated
USING (
