-- Deploy: schemas/agent_db_app_public/tables/workflow_runs/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".workflow_runs
FOR INSERT
TO authenticated
WITH CHECK (
