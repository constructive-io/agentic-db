-- Deploy: schemas/agent_db_app_public/tables/contact_notes/grants/authenticated/insert/grant
...
GRANT INSERT ON "agent_db_app_public".contact_notes TO authenticated;
