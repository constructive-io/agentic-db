-- Deploy: schemas/agent_db_app_public/tables/activity_log/indexes/activity_logs_activity_type_idx
...
CREATE INDEX activity_logs_activity_type_idx ON "agent_db_app_public".activity_log USING BTREE ( activity_type );
