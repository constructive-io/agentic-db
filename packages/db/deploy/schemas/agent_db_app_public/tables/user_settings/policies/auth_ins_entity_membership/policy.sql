-- Deploy: schemas/agent_db_app_public/tables/user_settings/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".user_settings
FOR INSERT
TO authenticated
WITH CHECK (
