-- Deploy: schemas/agentic_db_limits_public/tables/app_limit_defaults/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agentic_db_limits_public".app_limit_defaults
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
