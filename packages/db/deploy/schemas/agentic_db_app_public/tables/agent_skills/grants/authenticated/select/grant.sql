-- Deploy: schemas/agentic_db_app_public/tables/agent_skills/grants/authenticated/select/grant
...
GRANT SELECT ON "agentic_db_app_public".agent_skills TO authenticated;
