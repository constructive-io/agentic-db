-- Deploy: schemas/agentic_db_app_public/tables/files/columns/updated_at/alterations/alt0000001317
-- made with <3 @ constructive.io

-- requires: schemas/agentic_db_app_public/schema
-- requires: schemas/agentic_db_app_public/tables/files/table
-- requires: schemas/agentic_db_app_public/tables/files/columns/updated_at/column
