-- Deploy: schemas/agentic_db_app_public/tables/company_memories/grants/authenticated/select/grant
...
GRANT SELECT ON "agentic_db_app_public".company_memories TO authenticated;
