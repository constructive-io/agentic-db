-- Deploy: schemas/agentic_db_app_public/tables/user_settings/grants/authenticated/select/grant
...
GRANT SELECT ON "agentic_db_app_public".user_settings TO authenticated;
