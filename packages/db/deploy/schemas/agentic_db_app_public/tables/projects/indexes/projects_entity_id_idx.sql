-- Deploy: schemas/agentic_db_app_public/tables/projects/indexes/projects_entity_id_idx
...
CREATE INDEX projects_entity_id_idx ON "agentic_db_app_public".projects USING BTREE ( entity_id );
