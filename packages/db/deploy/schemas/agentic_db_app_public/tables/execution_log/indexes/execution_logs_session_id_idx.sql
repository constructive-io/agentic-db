-- Deploy: schemas/agentic_db_app_public/tables/execution_log/indexes/execution_logs_session_id_idx
...
CREATE INDEX execution_logs_session_id_idx ON "agentic_db_app_public".execution_log USING BTREE ( session_id );
