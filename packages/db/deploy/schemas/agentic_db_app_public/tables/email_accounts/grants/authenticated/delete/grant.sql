-- Deploy: schemas/agentic_db_app_public/tables/email_accounts/grants/authenticated/delete/grant
...
GRANT DELETE ON "agentic_db_app_public".email_accounts TO authenticated;
