-- Deploy: schemas/agentic_db_app_public/tables/workflows/columns/created_at/alterations/alt0000001209
-- made with <3 @ constructive.io

-- requires: schemas/agentic_db_app_public/schema
-- requires: schemas/agentic_db_app_public/tables/workflows/table
-- requires: schemas/agentic_db_app_public/tables/workflows/columns/created_at/column
