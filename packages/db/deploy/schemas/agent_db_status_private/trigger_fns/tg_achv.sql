-- Deploy: schemas/agent_db_status_private/trigger_fns/tg_achv
...
CREATE FUNCTION "agent_db_status_private".tg_achv ()
  RETURNS TRIGGER
  AS $$
DECLARE
  is_null boolean;
...
LANGUAGE 'plpgsql'
VOLATILE;
GRANT EXECUTE ON FUNCTION "agent_db_status_private".tg_achv TO authenticated;
