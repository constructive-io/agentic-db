-- Deploy: schemas/agent_db_limits_private/trigger_fns/app_limits_upd_tg
...
CREATE FUNCTION "agent_db_limits_private".app_limits_upd_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    limit_ok boolean;
...
BEGIN
    ...
    ELSIF (TG_NARGS = 2) THEN 
        ...
        PERFORM "agent_db_limits_private".app_limits_dec(
            limitname, old_actor_id
        );
        limit_ok = "agent_db_limits_private".app_limits_inc(
