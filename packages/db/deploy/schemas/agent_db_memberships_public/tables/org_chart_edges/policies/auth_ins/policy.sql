-- Deploy: schemas/agent_db_memberships_public/tables/org_chart_edges/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent_db_memberships_public".org_chart_edges
FOR INSERT
TO authenticated
WITH CHECK (
