-- Deploy: schemas/agent_db_permissions_public/tables/app_permission_defaults/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent_db_permissions_public".app_permission_defaults
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
