-- Deploy: schemas/agent-os-1773551593867-bac64076-profiles-private/trigger_fns/app_profile_grants_apply_tg
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-profiles-private".app_profile_grants_apply_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
