-- Deploy: schemas/agent-os-1773551593867-bac64076-profiles-private/trigger_fns/app_profiles_cascade_tg
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-profiles-private".app_profiles_cascade_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
