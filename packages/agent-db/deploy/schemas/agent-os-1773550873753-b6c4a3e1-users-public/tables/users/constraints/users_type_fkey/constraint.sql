-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-users-public/tables/users/constraints/users_type_fkey/constraint
...
ALTER TABLE "agent-os-1773550873753-b6c4a3e1-users-public".users 
  ADD CONSTRAINT users_type_fkey 
    FOREIGN KEY(type) 
    REFERENCES "agent-os-1773550873753-b6c4a3e1-users-public".role_types (id) 
    ON DELETE CASCADE;
