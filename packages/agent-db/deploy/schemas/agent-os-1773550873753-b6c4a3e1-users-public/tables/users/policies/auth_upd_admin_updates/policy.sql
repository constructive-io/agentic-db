-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-users-public/tables/users/policies/auth_upd_admin_updates/policy
...
CREATE POLICY auth_upd_admin_updates ON "agent-os-1773550873753-b6c4a3e1-users-public".users
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
