-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-users-public/tables/users/policies/auth_ins_insert_chk/policy
...
CREATE POLICY auth_ins_insert_chk ON "agent-os-1773550873753-b6c4a3e1-users-public".users
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
