-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-auth-private/tables/app_auth_settings/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773546821914-39f1cb9b-auth-private".app_auth_settings
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
