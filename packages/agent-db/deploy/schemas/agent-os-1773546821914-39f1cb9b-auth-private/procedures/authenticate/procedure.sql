-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-auth-private/procedures/authenticate/procedure
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-auth-private".authenticate (token_str text)
    RETURNS TABLE (
        id uuid,
        user_id uuid
    )
...
LANGUAGE 'sql' STABLE
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773546821914-39f1cb9b-auth-private".authenticate TO anonymous;
GRANT EXECUTE ON FUNCTION "agent-os-1773546821914-39f1cb9b-auth-private".authenticate TO authenticated;
