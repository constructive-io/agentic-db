-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-auth-private/procedures/authenticate_strict/procedure
...
-- requires: schemas/agent-os-1773546821914-39f1cb9b-auth-private/tables/session_credentials/columns/expires_at/column
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-auth-private".authenticate_strict (token_str text)
    RETURNS TABLE (
        id uuid,
        user_id uuid
    )
...
SELECT
    ...
    sess.user_id
FROM
    "agent-os-1773546821914-39f1cb9b-auth-private".session_credentials AS cred
    JOIN "agent-os-1773546821914-39f1cb9b-auth-private".sessions AS sess ON sess.id = cred.session_id
WHERE
...
LANGUAGE 'sql' STABLE
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773546821914-39f1cb9b-auth-private".authenticate_strict TO anonymous;
GRANT EXECUTE ON FUNCTION "agent-os-1773546821914-39f1cb9b-auth-private".authenticate_strict TO authenticated;
