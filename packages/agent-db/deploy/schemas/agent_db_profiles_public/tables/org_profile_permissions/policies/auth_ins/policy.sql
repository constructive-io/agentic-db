-- Deploy: schemas/agent_db_profiles_public/tables/org_profile_permissions/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON agent_db_profiles_public.org_profile_permissions
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
