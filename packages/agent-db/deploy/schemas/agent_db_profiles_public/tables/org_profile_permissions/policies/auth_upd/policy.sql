-- Deploy: schemas/agent_db_profiles_public/tables/org_profile_permissions/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent_db_profiles_public".org_profile_permissions
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
