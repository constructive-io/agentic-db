-- Deploy: schemas/agent_db_profiles_public/tables/org_profile_definition_grants/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent_db_profiles_public".org_profile_definition_grants
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
