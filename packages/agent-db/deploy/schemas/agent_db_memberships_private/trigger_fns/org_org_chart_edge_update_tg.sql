-- Deploy: schemas/agent_db_memberships_private/trigger_fns/org_org_chart_edge_update_tg
-- made with <3 @ launchql.com

-- requires: schemas/agent_db_memberships_private/schema


CREATE FUNCTION agent_db_memberships_private.org_org_chart_edge_update_tg() RETURNS TRIGGER AS $_PGFN_$
