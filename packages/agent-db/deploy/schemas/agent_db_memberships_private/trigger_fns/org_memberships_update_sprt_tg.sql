-- Deploy: schemas/agent_db_memberships_private/trigger_fns/org_memberships_update_sprt_tg
...
CREATE FUNCTION "agent_db_memberships_private".org_memberships_update_sprt_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    v_num_updated int;
