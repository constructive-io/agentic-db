-- Deploy: schemas/agent-os-1773551593867-bac64076-encrypted/trigger_fns/encrypted_secrets_hash
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-encrypted".encrypted_secrets_hash ()
RETURNS TRIGGER
AS $CODEZ$
BEGIN
