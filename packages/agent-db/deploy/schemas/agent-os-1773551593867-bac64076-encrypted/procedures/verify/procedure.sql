-- Deploy: schemas/agent-os-1773551593867-bac64076-encrypted/procedures/verify/procedure
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-encrypted".verify (
  owner_id uuid,
  secret_name text,
  value text
)
...
BEGIN
  SELECT
    *
  FROM
    "agent-os-1773551593867-bac64076-encrypted".get (verify.owner_id, verify.secret_name)
  INTO v_secret_text;
  SELECT
    *
  FROM
...
LANGUAGE 'plpgsql'
STABLE;
GRANT EXECUTE ON FUNCTION "agent-os-1773551593867-bac64076-encrypted".verify TO authenticated;
