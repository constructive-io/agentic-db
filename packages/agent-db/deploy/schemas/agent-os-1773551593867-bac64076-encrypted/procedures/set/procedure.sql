-- Deploy: schemas/agent-os-1773551593867-bac64076-encrypted/procedures/set/procedure
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-encrypted".set (
  v_owner_id uuid,
  secret_name text,
  secret_value text,
  v_algo text = 'pgp'
  ...
  AS $$
BEGIN
  INSERT INTO "agent-os-1773551593867-bac64076-encrypted".encrypted_secrets (owner_id, name, value, algo)
...
LANGUAGE 'plpgsql'
VOLATILE;
GRANT EXECUTE ON FUNCTION "agent-os-1773551593867-bac64076-encrypted".set TO authenticated;
