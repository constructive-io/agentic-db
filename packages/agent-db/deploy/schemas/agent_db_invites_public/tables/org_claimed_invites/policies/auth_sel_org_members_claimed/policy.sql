-- Deploy: schemas/agent_db_invites_public/tables/org_claimed_invites/policies/auth_sel_org_members_claimed/policy
...
CREATE POLICY auth_sel_org_members_claimed ON agent_db_invites_public.org_claimed_invites
FOR SELECT
TO authenticated
USING (
