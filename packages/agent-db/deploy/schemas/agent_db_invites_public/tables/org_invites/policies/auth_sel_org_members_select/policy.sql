-- Deploy: schemas/agent_db_invites_public/tables/org_invites/policies/auth_sel_org_members_select/policy
...
CREATE POLICY auth_sel_org_members_select ON agent_db_invites_public.org_invites
FOR SELECT
TO authenticated
USING (
