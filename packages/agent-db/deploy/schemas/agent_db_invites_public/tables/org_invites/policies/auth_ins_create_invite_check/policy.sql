-- Deploy: schemas/agent_db_invites_public/tables/org_invites/policies/auth_ins_create_invite_check/policy
...
CREATE POLICY auth_ins_create_invite_check ON "agent_db_invites_public".org_invites
AS RESTRICTIVE
FOR INSERT
TO authenticated
WITH CHECK (
