-- Deploy: schemas/agent-os-1773547105079-c748b4c3-limits-public/tables/app_limits/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773547105079-c748b4c3-limits-public".app_limits
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
