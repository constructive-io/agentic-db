-- Deploy: schemas/agent-os-1773547105079-c748b4c3-limits-public/tables/app_limits/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773547105079-c748b4c3-limits-public".app_limits
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
