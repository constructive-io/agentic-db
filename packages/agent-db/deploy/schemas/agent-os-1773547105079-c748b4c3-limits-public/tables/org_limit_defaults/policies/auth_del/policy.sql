-- Deploy: schemas/agent-os-1773547105079-c748b4c3-limits-public/tables/org_limit_defaults/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773547105079-c748b4c3-limits-public".org_limit_defaults
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
