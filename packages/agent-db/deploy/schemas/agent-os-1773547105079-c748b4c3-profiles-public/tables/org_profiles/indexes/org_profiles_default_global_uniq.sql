-- Deploy: schemas/agent-os-1773547105079-c748b4c3-profiles-public/tables/org_profiles/indexes/org_profiles_default_global_uniq
...
CREATE UNIQUE INDEX org_profiles_default_global_uniq ON "agent-os-1773547105079-c748b4c3-profiles-public".org_profiles ( (true::boolean) ) WHERE is_default = true AND entity_id IS NULL;
