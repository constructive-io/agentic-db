-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-encrypted/procedures/get/procedure
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-encrypted".get (
  owner_id uuid,
  secret_name text,
...
LANGUAGE 'plpgsql'
STABLE;
GRANT EXECUTE ON FUNCTION "agent-os-1773546821914-39f1cb9b-encrypted".get TO authenticated;
