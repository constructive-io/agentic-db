-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-encrypted/procedures/set/procedure
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-encrypted".set (
  v_owner_id uuid,
  secret_name text,
  secret_value text,
  v_algo text = 'pgp'
  ...
  AS $$
BEGIN
  INSERT INTO "agent-os-1773546821914-39f1cb9b-encrypted".encrypted_secrets (owner_id, name, value, algo)
...
LANGUAGE 'plpgsql'
VOLATILE;
GRANT EXECUTE ON FUNCTION "agent-os-1773546821914-39f1cb9b-encrypted".set TO authenticated;
