-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-profiles-public/tables/org_profiles/indexes/org_profiles_default_entity_uniq
...
CREATE UNIQUE INDEX org_profiles_default_entity_uniq ON "agent-os-1773546821914-39f1cb9b-profiles-public".org_profiles ( entity_id ) WHERE is_default = true AND entity_id IS NOT NULL;
