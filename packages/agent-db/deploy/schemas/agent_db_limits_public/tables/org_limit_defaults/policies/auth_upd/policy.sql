-- Deploy: schemas/agent_db_limits_public/tables/org_limit_defaults/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON agent_db_limits_public.org_limit_defaults
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
