-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-profiles-public/tables/org_profile_definition_grants/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773550873753-b6c4a3e1-profiles-public".org_profile_definition_grants
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
