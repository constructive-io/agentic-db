-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-profiles-public/tables/org_profile_definition_grants/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agent-os-1773550873753-b6c4a3e1-profiles-public".org_profile_definition_grants
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
