-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-profiles-public/tables/org_profiles/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773550873753-b6c4a3e1-profiles-public".org_profiles
FOR UPDATE
TO authenticated
USING (
