-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-user-identifiers-public/tables/emails/triggers/emails_immutable_tg
...
BEFORE UPDATE ON "agent-os-1773550873753-b6c4a3e1-user-identifiers-public".emails
FOR EACH ROW
