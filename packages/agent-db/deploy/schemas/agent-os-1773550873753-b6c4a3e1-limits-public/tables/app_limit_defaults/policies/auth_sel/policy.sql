-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-limits-public/tables/app_limit_defaults/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agent-os-1773550873753-b6c4a3e1-limits-public".app_limit_defaults
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
