-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-profiles-private/trigger_fns/app_memberships_profile_sync_tg
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-profiles-private".app_memberships_profile_sync_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
