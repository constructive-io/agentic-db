-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-profiles-private/trigger_fns/org_profile_grants_apply_tg
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-profiles-private".org_profile_grants_apply_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
