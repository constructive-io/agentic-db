-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-profiles-private/trigger_fns/app_profiles_cascade_tg
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-profiles-private".app_profiles_cascade_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
