-- Deploy: schemas/agent-os-1773551593867-bac64076-limits-private/trigger_fns/org_limits_upd_tg
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-limits-private".org_limits_upd_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    limit_ok boolean;
...
BEGIN
    ...
    ELSIF (TG_NARGS = 2) THEN 
        ...
        PERFORM "agent-os-1773551593867-bac64076-limits-private".org_limits_dec(
            limitname, old_actor_id
        );
        limit_ok = "agent-os-1773551593867-bac64076-limits-private".org_limits_inc(
