-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-private/trigger_fns/users_search_tsv_tsv
-- made with <3 @ launchql.com

-- requires: schemas/agent-os-1773550873753-b6c4a3e1-private/schema


CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-private".users_search_tsv_tsv() RETURNS TRIGGER AS $_PGFN_$
