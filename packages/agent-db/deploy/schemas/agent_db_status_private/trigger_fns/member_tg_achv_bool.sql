-- Deploy: schemas/agent_db_status_private/trigger_fns/member_tg_achv_bool
...
CREATE FUNCTION "agent_db_status_private".member_tg_achv_bool ()
  RETURNS TRIGGER
  AS $$
DECLARE
  is_true boolean;
...
LANGUAGE 'plpgsql'
VOLATILE;
GRANT EXECUTE ON FUNCTION "agent_db_status_private".member_tg_achv_bool TO authenticated;
