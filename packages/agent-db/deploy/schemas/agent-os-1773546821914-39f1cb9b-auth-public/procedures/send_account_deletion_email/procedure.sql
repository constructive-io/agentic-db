-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-auth-public/procedures/send_account_deletion_email/procedure
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-auth-public".send_account_deletion_email ()
    RETURNS boolean
AS $$
DECLARE
...
BEGIN
    ...
    account_deletion_email_sent_at = "agent-os-1773546821914-39f1cb9b-simple-secrets".get(v_user_id, 'account_deletion_email_sent_at');
    IF (
    ...
    PERFORM "agent-os-1773546821914-39f1cb9b-simple-secrets".set(v_user_id, 'account_deletion_email_sent_at', (NOW())::text);
    PERFORM
        app_jobs.add_job (
...
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773546821914-39f1cb9b-auth-public".send_account_deletion_email TO authenticated;
