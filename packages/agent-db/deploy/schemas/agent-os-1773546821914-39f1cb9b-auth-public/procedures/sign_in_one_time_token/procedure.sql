-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-auth-public/procedures/sign_in_one_time_token/procedure
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-auth-public".sign_in_one_time_token (
  token text,
...
BEGIN
    ...
    FROM "agent-os-1773546821914-39f1cb9b-auth-private".session_credentials c
    JOIN "agent-os-1773546821914-39f1cb9b-auth-private".sessions s ON s.id = c.session_id
...
LANGUAGE 'plpgsql'
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773546821914-39f1cb9b-auth-public".sign_in_one_time_token TO anonymous;
