-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-auth-public/procedures/extend_token_expires/procedure
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-auth-public".extend_token_expires (
...
DECLARE
  ...
  v_credential "agent-os-1773546821914-39f1cb9b-auth-private".session_credentials;
  v_session "agent-os-1773546821914-39f1cb9b-auth-private".sessions;
BEGIN
    IF (v_token_id IS NULL) THEN 
      RETURN;
    END IF;
    SELECT cred.* FROM "agent-os-1773546821914-39f1cb9b-auth-private".session_credentials cred
    ...
    IF (NOT FOUND) THEN 
      RETURN;
    END IF;
    SELECT sess.* FROM "agent-os-1773546821914-39f1cb9b-auth-private".sessions sess
    ...
    IF (NOT FOUND) THEN 
      RETURN;
    END IF;
    UPDATE "agent-os-1773546821914-39f1cb9b-auth-private".session_credentials c
    SET 
...
STRICT
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773546821914-39f1cb9b-auth-public".extend_token_expires TO authenticated;
