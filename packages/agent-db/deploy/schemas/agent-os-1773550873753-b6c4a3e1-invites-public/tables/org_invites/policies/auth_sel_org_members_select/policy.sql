-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-invites-public/tables/org_invites/policies/auth_sel_org_members_select/policy
...
CREATE POLICY auth_sel_org_members_select ON "agent-os-1773550873753-b6c4a3e1-invites-public".org_invites
FOR SELECT
TO authenticated
USING (
