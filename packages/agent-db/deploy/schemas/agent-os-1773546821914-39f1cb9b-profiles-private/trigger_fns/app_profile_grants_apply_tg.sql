-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-profiles-private/trigger_fns/app_profile_grants_apply_tg
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-profiles-private".app_profile_grants_apply_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
