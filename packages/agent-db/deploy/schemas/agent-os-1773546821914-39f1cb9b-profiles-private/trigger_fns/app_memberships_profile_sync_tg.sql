-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-profiles-private/trigger_fns/app_memberships_profile_sync_tg
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-profiles-private".app_memberships_profile_sync_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
