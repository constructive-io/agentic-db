-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-user-identifiers-public/tables/emails/triggers/emails_immutable_tg
...
BEFORE UPDATE ON "agent-os-1773546821914-39f1cb9b-user-identifiers-public".emails
FOR EACH ROW
