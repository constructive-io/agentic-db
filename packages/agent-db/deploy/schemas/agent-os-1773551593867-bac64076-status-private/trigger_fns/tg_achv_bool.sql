-- Deploy: schemas/agent-os-1773551593867-bac64076-status-private/trigger_fns/tg_achv_bool
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-status-private".tg_achv_bool ()
  RETURNS TRIGGER
  AS $$
DECLARE
  is_true boolean;
...
LANGUAGE 'plpgsql'
VOLATILE;
GRANT EXECUTE ON FUNCTION "agent-os-1773551593867-bac64076-status-private".tg_achv_bool TO authenticated;
