-- Deploy: schemas/agent-os-1773551593867-bac64076-status-private/trigger_fns/tg_achv_tgl
...
-- requires: schemas/agent-os-1773551593867-bac64076-status-private/procedures/incompleted_step/procedure



CREATE FUNCTION "agent-os-1773551593867-bac64076-status-private".tg_achv_tgl ()
  RETURNS TRIGGER
  AS $$
DECLARE
  is_null boolean;
...
LANGUAGE 'plpgsql'
VOLATILE;
GRANT EXECUTE ON FUNCTION "agent-os-1773551593867-bac64076-status-private".tg_achv_tgl TO authenticated;
