-- Deploy: schemas/agent_db_auth_public/procedures/check_password/procedure
...
CREATE FUNCTION "agent_db_auth_public".check_password (
  password text
)
  RETURNS void
  AS $$
...
$$
LANGUAGE 'plpgsql';
GRANT EXECUTE ON FUNCTION "agent_db_auth_public".check_password TO public;
