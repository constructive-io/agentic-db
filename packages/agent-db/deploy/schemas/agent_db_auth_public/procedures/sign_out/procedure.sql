-- Deploy: schemas/agent_db_auth_public/procedures/sign_out/procedure
...
CREATE FUNCTION agent_db_auth_public.sign_out ()
  RETURNS void
  AS $$
DECLARE
...
BEGIN
  IF (v_session_id IS NOT NULL) THEN 
    UPDATE agent_db_auth_private.session_credentials cred
      SET revoked_at = NOW()
...
VOLATILE
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION agent_db_auth_public.sign_out TO authenticated;
