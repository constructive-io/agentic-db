-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-public/tables/org_memberships/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773551593867-bac64076-memberships-public".org_memberships
FOR UPDATE
TO authenticated
USING (
