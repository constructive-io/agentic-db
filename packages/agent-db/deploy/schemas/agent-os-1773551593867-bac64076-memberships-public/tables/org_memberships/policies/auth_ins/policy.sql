-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-public/tables/org_memberships/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773551593867-bac64076-memberships-public".org_memberships
FOR INSERT
TO authenticated
WITH CHECK (
