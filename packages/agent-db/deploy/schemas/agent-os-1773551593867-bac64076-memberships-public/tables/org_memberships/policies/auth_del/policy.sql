-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-public/tables/org_memberships/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773551593867-bac64076-memberships-public".org_memberships
FOR DELETE
TO authenticated
USING (
