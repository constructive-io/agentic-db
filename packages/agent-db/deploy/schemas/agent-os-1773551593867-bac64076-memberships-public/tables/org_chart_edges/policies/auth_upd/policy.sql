-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-public/tables/org_chart_edges/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773551593867-bac64076-memberships-public".org_chart_edges
FOR UPDATE
TO authenticated
USING (
