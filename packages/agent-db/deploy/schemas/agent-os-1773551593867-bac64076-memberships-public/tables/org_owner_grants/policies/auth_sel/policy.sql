-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-public/tables/org_owner_grants/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agent-os-1773551593867-bac64076-memberships-public".org_owner_grants
FOR SELECT
TO authenticated
USING (
