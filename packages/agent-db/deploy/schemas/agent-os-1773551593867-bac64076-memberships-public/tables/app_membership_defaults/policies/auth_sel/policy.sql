-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-public/tables/app_membership_defaults/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agent-os-1773551593867-bac64076-memberships-public".app_membership_defaults
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
