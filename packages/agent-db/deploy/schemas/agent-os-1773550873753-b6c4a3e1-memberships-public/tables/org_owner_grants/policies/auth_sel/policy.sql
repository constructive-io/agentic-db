-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-public/tables/org_owner_grants/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agent-os-1773550873753-b6c4a3e1-memberships-public".org_owner_grants
FOR SELECT
TO authenticated
USING (
