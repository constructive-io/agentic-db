-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-public/tables/app_admin_grants/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773550873753-b6c4a3e1-memberships-public".app_admin_grants
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
