-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-public/tables/app_memberships/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773550873753-b6c4a3e1-memberships-public".app_memberships
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
