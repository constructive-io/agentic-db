-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-public/tables/org_chart_edges/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773550873753-b6c4a3e1-memberships-public".org_chart_edges
FOR UPDATE
TO authenticated
USING (
