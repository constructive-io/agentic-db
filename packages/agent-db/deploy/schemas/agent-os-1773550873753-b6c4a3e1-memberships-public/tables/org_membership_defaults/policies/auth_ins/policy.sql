-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-public/tables/org_membership_defaults/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773550873753-b6c4a3e1-memberships-public".org_membership_defaults
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
