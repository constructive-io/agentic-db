-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-public/tables/app_membership_defaults/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773550873753-b6c4a3e1-memberships-public".app_membership_defaults
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
