-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-public/procedures/org_get_subordinates/procedure
-- made with <3 @ launchql.com

-- requires: schemas/agent-os-1773550873753-b6c4a3e1-memberships-public/schema


CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-memberships-public".org_get_subordinates(
  IN p_entity_id uuid,
  IN p_user_id uuid,
