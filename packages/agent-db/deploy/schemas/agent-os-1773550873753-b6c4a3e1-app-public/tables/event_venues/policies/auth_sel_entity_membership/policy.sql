-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/event_venues/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent-os-1773550873753-b6c4a3e1-app-public".event_venues
FOR SELECT
TO authenticated
USING (
