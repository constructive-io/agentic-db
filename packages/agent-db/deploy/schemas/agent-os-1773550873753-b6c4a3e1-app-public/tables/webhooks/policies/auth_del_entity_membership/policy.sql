-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/webhooks/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent-os-1773550873753-b6c4a3e1-app-public".webhooks
FOR DELETE
TO authenticated
USING (
