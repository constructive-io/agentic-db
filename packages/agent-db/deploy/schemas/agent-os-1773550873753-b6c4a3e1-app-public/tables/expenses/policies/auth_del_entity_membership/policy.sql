-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/expenses/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent-os-1773550873753-b6c4a3e1-app-public".expenses
FOR DELETE
TO authenticated
USING (
