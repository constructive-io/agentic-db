-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/images/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent-os-1773550873753-b6c4a3e1-app-public".images
FOR INSERT
TO authenticated
WITH CHECK (
