-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/workflow_runs/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON "agent-os-1773550873753-b6c4a3e1-app-public".workflow_runs
FOR UPDATE
TO authenticated
USING (
