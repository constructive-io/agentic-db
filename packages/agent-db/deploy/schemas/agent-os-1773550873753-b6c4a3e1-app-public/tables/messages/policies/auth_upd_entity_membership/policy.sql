-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/messages/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON "agent-os-1773550873753-b6c4a3e1-app-public".messages
FOR UPDATE
TO authenticated
USING (
