-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/agent_skills/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent-os-1773550873753-b6c4a3e1-app-public".agent_skills
FOR INSERT
TO authenticated
WITH CHECK (
