-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/deal_contacts/constraints/deal_contacts_deal_id_fkey/constraint
...
ALTER TABLE "agent-os-1773550873753-b6c4a3e1-app-public".deal_contacts 
  ADD CONSTRAINT deal_contacts_deal_id_fkey 
    FOREIGN KEY(deal_id) 
    REFERENCES "agent-os-1773550873753-b6c4a3e1-app-public".deals (id) 
    ON DELETE CASCADE;
