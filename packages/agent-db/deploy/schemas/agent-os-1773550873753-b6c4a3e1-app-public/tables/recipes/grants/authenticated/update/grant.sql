-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/recipes/grants/authenticated/update/grant
...
GRANT UPDATE ON "agent-os-1773550873753-b6c4a3e1-app-public".recipes TO authenticated;
