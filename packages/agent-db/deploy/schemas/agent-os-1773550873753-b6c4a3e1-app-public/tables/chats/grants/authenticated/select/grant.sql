-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/chats/grants/authenticated/select/grant
...
GRANT SELECT ON "agent-os-1773550873753-b6c4a3e1-app-public".chats TO authenticated;
