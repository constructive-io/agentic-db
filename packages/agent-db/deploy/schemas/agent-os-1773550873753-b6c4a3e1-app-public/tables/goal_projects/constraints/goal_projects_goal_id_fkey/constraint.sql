-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/goal_projects/constraints/goal_projects_goal_id_fkey/constraint
...
ALTER TABLE "agent-os-1773550873753-b6c4a3e1-app-public".goal_projects 
  ADD CONSTRAINT goal_projects_goal_id_fkey 
    FOREIGN KEY(goal_id) 
    REFERENCES "agent-os-1773550873753-b6c4a3e1-app-public".goals (id) 
    ON DELETE CASCADE;
