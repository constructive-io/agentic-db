-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-app-public/tables/documents/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent-os-1773550873753-b6c4a3e1-app-public".documents
FOR DELETE
TO authenticated
USING (
