-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-permissions-public/tables/app_permissions/fixtures/fix0000000161
...
INSERT INTO "agent-os-1773550873753-b6c4a3e1-permissions-public".app_permissions (
  bitnum,
  name,
  description
)
