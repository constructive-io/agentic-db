-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-permissions-public/tables/app_permissions/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773550873753-b6c4a3e1-permissions-public".app_permissions
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
