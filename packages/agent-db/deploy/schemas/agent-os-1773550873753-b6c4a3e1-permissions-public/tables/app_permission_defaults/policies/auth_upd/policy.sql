-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-permissions-public/tables/app_permission_defaults/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773550873753-b6c4a3e1-permissions-public".app_permission_defaults
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
