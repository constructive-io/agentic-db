-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-permissions-public/tables/org_permissions/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773550873753-b6c4a3e1-permissions-public".org_permissions
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
