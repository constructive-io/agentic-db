-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-permissions-public/tables/org_permissions/fixtures/fix0000000433
...
INSERT INTO "agent-os-1773550873753-b6c4a3e1-permissions-public".org_permissions (
  bitnum,
  name,
  description
)
