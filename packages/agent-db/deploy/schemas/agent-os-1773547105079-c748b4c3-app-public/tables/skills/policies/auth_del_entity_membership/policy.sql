-- Deploy: schemas/agent-os-1773547105079-c748b4c3-app-public/tables/skills/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent-os-1773547105079-c748b4c3-app-public".skills
FOR DELETE
TO authenticated
USING (
