-- Deploy: schemas/agent-os-1773547105079-c748b4c3-app-public/tables/ideas/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON "agent-os-1773547105079-c748b4c3-app-public".ideas
FOR UPDATE
TO authenticated
USING (
