-- Deploy: schemas/agent-os-1773547105079-c748b4c3-app-public/tables/deal_contacts/constraints/deal_contacts_deal_id_fkey/constraint
...
ALTER TABLE "agent-os-1773547105079-c748b4c3-app-public".deal_contacts 
  ADD CONSTRAINT deal_contacts_deal_id_fkey 
    FOREIGN KEY(deal_id) 
    REFERENCES "agent-os-1773547105079-c748b4c3-app-public".deals (id) 
    ON DELETE CASCADE;
