-- Deploy: schemas/agent-os-1773547105079-c748b4c3-app-public/tables/workflow_steps/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent-os-1773547105079-c748b4c3-app-public".workflow_steps
FOR INSERT
TO authenticated
WITH CHECK (
