-- Deploy: schemas/agent-os-1773547105079-c748b4c3-app-public/tables/event_images/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent-os-1773547105079-c748b4c3-app-public".event_images
FOR SELECT
TO authenticated
USING (
