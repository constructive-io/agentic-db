-- Deploy: schemas/agent-os-1773547105079-c748b4c3-app-public/tables/expenses/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent-os-1773547105079-c748b4c3-app-public".expenses
FOR DELETE
TO authenticated
USING (
