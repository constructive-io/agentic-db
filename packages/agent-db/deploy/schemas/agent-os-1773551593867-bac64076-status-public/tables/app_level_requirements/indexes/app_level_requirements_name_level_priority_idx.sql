-- Deploy: schemas/agent-os-1773551593867-bac64076-status-public/tables/app_level_requirements/indexes/app_level_requirements_name_level_priority_idx
...
CREATE INDEX app_level_requirements_name_level_priority_idx ON "agent-os-1773551593867-bac64076-status-public".app_level_requirements USING BTREE ( name, level, priority );
