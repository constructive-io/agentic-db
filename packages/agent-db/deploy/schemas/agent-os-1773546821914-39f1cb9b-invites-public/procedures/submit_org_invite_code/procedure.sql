-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-invites-public/procedures/submit_org_invite_code/procedure
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-invites-public".submit_org_invite_code (
  token text
)
  RETURNS boolean
  AS $$
DECLARE
  ...
  v_invite "agent-os-1773546821914-39f1cb9b-invites-public".org_invites;
BEGIN
  ...
  SELECT * FROM "agent-os-1773546821914-39f1cb9b-invites-public".org_invites i
  ...
  IF (v_email.email IS NOT NULL OR v_invite.multiple IS FALSE) THEN 
    UPDATE "agent-os-1773546821914-39f1cb9b-invites-public".org_invites 
  ...
  WHERE id = v_invite.id;
  INSERT INTO "agent-os-1773546821914-39f1cb9b-invites-public".org_claimed_invites 
    (sender_id, receiver_id, data, entity_id)
  VALUES (v_invite.sender_id, v_user.id, v_invite.data, v_invite.entity_id);
  IF (
    "agent-os-1773546821914-39f1cb9b-memberships-private".org_memberships_perm_check(
...
VOLATILE
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773546821914-39f1cb9b-invites-public".submit_org_invite_code TO authenticated;
