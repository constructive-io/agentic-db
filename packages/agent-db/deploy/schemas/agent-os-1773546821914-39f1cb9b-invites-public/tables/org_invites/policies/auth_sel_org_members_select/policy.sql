-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-invites-public/tables/org_invites/policies/auth_sel_org_members_select/policy
...
CREATE POLICY auth_sel_org_members_select ON "agent-os-1773546821914-39f1cb9b-invites-public".org_invites
FOR SELECT
TO authenticated
USING (
