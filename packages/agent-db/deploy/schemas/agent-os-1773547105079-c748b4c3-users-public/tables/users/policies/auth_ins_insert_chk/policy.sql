-- Deploy: schemas/agent-os-1773547105079-c748b4c3-users-public/tables/users/policies/auth_ins_insert_chk/policy
...
CREATE POLICY auth_ins_insert_chk ON "agent-os-1773547105079-c748b4c3-users-public".users
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
