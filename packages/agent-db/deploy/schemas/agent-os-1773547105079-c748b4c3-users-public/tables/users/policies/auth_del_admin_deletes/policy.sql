-- Deploy: schemas/agent-os-1773547105079-c748b4c3-users-public/tables/users/policies/auth_del_admin_deletes/policy
...
CREATE POLICY auth_del_admin_deletes ON "agent-os-1773547105079-c748b4c3-users-public".users
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
