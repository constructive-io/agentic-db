-- Deploy: schemas/agent-os-1773547105079-c748b4c3-users-public/tables/users/triggers/users_search_tsv_tsv_insert_tg
...
BEFORE INSERT ON "agent-os-1773547105079-c748b4c3-users-public".users
FOR EACH ROW
