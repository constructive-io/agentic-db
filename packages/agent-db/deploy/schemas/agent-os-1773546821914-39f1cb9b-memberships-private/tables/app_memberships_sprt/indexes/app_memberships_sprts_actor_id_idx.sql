-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-private/tables/app_memberships_sprt/indexes/app_memberships_sprts_actor_id_idx
...
-- requires: schemas/agent-os-1773546821914-39f1cb9b-memberships-private/tables/app_memberships_sprt/columns/is_admin/column
...
CREATE UNIQUE INDEX app_memberships_sprts_actor_id_idx ON "agent-os-1773546821914-39f1cb9b-memberships-private".app_memberships_sprt USING BTREE ( actor_id ) INCLUDE ( permissions, is_owner, is_admin );
