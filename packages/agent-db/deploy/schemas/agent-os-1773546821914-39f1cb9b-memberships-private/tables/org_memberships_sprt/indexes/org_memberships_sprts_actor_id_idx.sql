-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-private/tables/org_memberships_sprt/indexes/org_memberships_sprts_actor_id_idx
...
CREATE INDEX org_memberships_sprts_actor_id_idx ON "agent-os-1773546821914-39f1cb9b-memberships-private".org_memberships_sprt USING BTREE ( actor_id ) INCLUDE ( permissions, is_owner, is_admin );
