-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-private/trigger_fns/app_memberships_insert_sprt_tg
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-memberships-private".app_memberships_insert_sprt_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
BEGIN
