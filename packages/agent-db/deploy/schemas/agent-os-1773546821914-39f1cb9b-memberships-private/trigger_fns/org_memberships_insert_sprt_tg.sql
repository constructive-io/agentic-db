-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-private/trigger_fns/org_memberships_insert_sprt_tg
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-memberships-private".org_memberships_insert_sprt_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
