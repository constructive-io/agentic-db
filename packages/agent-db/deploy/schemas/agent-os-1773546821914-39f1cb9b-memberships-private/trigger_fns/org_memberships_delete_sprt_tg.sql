-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-private/trigger_fns/org_memberships_delete_sprt_tg
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-memberships-private".org_memberships_delete_sprt_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    v_num_updated int;
