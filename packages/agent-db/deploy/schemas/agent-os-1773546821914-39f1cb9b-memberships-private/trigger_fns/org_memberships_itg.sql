-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-private/trigger_fns/org_memberships_itg
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-memberships-private".org_memberships_itg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    bitlen int = bit_length(NEW.permissions);
    defaults bit varying;
    memdefs "agent-os-1773546821914-39f1cb9b-memberships-public".org_membership_defaults;
BEGIN
    SELECT * FROM
        "agent-os-1773546821914-39f1cb9b-memberships-public".org_membership_defaults t 
    ...
    SELECT permissions FROM
        "agent-os-1773546821914-39f1cb9b-permissions-public".org_permission_defaults t 
        WHERE t.entity_id = NEW.entity_id
    INTO defaults;
    IF (NOT FOUND) THEN 
