-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-private/trigger_fns/app_memberships_utg
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-memberships-private".app_memberships_utg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
