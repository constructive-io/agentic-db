-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-status-public/tables/org_steps/indexes/org_steps_actor_id_name_entity_id_idx
...
CREATE INDEX org_steps_actor_id_name_entity_id_idx ON "agent-os-1773550873753-b6c4a3e1-status-public".org_steps USING BTREE ( actor_id, name, entity_id );
