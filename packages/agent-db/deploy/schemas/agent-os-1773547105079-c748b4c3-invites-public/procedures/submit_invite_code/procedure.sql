-- Deploy: schemas/agent-os-1773547105079-c748b4c3-invites-public/procedures/submit_invite_code/procedure
-- made with <3 @ launchql.com

-- requires: schemas/agent-os-1773547105079-c748b4c3-invites-public/schema
-- requires: schemas/agent-os-1773547105079-c748b4c3-memberships-public/tables/app_memberships/table
-- requires: schemas/agent-os-1773547105079-c748b4c3-memberships-private/procedures/app_memberships_perm_check/procedure



CREATE FUNCTION "agent-os-1773547105079-c748b4c3-invites-public".submit_invite_code (
  token text
)
  RETURNS boolean
  AS $$
DECLARE
  ...
  v_invite "agent-os-1773547105079-c748b4c3-invites-public".invites;
BEGIN
  ...
  SELECT * FROM "agent-os-1773547105079-c748b4c3-invites-public".invites i
  ...
  IF (v_email.email IS NOT NULL OR v_invite.multiple IS FALSE) THEN 
    UPDATE "agent-os-1773547105079-c748b4c3-invites-public".invites 
  ...
  WHERE id = v_invite.id;
  INSERT INTO "agent-os-1773547105079-c748b4c3-invites-public".claimed_invites 
    (sender_id, receiver_id, data)
  VALUES (v_invite.sender_id, v_user.id, v_invite.data);
  IF (
    "agent-os-1773547105079-c748b4c3-memberships-private".app_memberships_perm_check(
        'send_approved_invites',
        v_invite.sender_id
    ) IS TRUE
   ) THEN
    INSERT INTO "agent-os-1773547105079-c748b4c3-memberships-public".app_memberships 
...
VOLATILE
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-invites-public".submit_invite_code TO authenticated;
