-- Deploy: schemas/agent-os-1773547105079-c748b4c3-invites-public/tables/org_invites/policies/auth_sel_org_members_select/policy
...
CREATE POLICY auth_sel_org_members_select ON "agent-os-1773547105079-c748b4c3-invites-public".org_invites
FOR SELECT
TO authenticated
USING (
