-- Deploy: schemas/agent-os-1773547105079-c748b4c3-auth-public/procedures/forgot_password/procedure
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".forgot_password (email email)
    RETURNS void
AS $$
DECLARE
...
BEGIN
    ...
    IF (
        ...
        RETURN;
    END IF;
    password_reset_email_sent_at = "agent-os-1773547105079-c748b4c3-simple-secrets".get(v_user_id, 'password_reset_email_sent_at');
    IF (
    ...
    PERFORM "agent-os-1773547105079-c748b4c3-simple-secrets".set(v_user_id, 'password_reset_email_sent_at', (NOW())::text);
    PERFORM
        app_jobs.add_job (
...
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".forgot_password TO anonymous;
