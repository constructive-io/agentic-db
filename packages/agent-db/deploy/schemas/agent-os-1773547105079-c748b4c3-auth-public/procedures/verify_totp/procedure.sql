-- Deploy: schemas/agent-os-1773547105079-c748b4c3-auth-public/procedures/verify_totp/procedure
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".verify_totp (
  totp_value text
)
...
BEGIN
  ...
  first_failed_totp_attempt = "agent-os-1773547105079-c748b4c3-simple-secrets".get(v_user_id, 'first_failed_totp_attempt');
  totp_attempts = "agent-os-1773547105079-c748b4c3-simple-secrets".get(v_user_id, 'totp_attempts');
  
  totp_secret = "agent-os-1773547105079-c748b4c3-simple-secrets".get(v_user_id, 'totp_secret');
  ...
  ELSE
   INSERT INTO "agent-os-1773547105079-c748b4c3-logging-public".audit_logs 
    ...
    END IF;
    PERFORM "agent-os-1773547105079-c748b4c3-simple-secrets".set(v_user_id, 'totp_attempts', totp_attempts);
    PERFORM "agent-os-1773547105079-c748b4c3-simple-secrets".set(v_user_id, 'first_failed_totp_attempt', first_failed_totp_attempt);
    RETURN NULL;
  END IF;
END;
$$
...
STRICT
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".verify_totp TO authenticated;
REVOKE EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".verify_totp FROM anonymous;
