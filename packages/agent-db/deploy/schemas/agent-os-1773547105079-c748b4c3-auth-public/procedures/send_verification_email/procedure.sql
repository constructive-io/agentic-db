-- Deploy: schemas/agent-os-1773547105079-c748b4c3-auth-public/procedures/send_verification_email/procedure
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".send_verification_email(email email)
RETURNS boolean AS $$
DECLARE
...
BEGIN
  ...
  IF ( v_email.is_verified IS TRUE ) THEN
    PERFORM "agent-os-1773547105079-c748b4c3-simple-secrets".del(v_email.owner_id, ARRAY[
        'verification_email_sent_at',
        'verification_email_attempts',
        'first_failed_verification_email_attempt'
    ]);
    PERFORM "agent-os-1773547105079-c748b4c3-encrypted".del(v_email.owner_id, ARRAY[
  ...
  IF (
    ...
    v_verification_token = "agent-os-1773547105079-c748b4c3-encrypted".get
  ...
  PERFORM "agent-os-1773547105079-c748b4c3-simple-secrets".set
...
GRANT EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".send_verification_email TO authenticated, anonymous;
