-- Deploy: schemas/agent-os-1773547105079-c748b4c3-auth-public/procedures/sign_in_one_time_token/procedure
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".sign_in_one_time_token (
  token text,
...
BEGIN
    ...
    FROM "agent-os-1773547105079-c748b4c3-auth-private".session_credentials c
    JOIN "agent-os-1773547105079-c748b4c3-auth-private".sessions s ON s.id = c.session_id
...
LANGUAGE 'plpgsql'
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".sign_in_one_time_token TO anonymous;
