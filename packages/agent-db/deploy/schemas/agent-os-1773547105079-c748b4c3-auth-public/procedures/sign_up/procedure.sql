-- Deploy: schemas/agent-os-1773547105079-c748b4c3-auth-public/procedures/sign_up/procedure
...
-- requires: schemas/agent-os-1773547105079-c748b4c3-auth-public/procedures/check_password/procedure



CREATE FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".sign_up (
  email text,
  password text,
...
BEGIN
  ...
  IF (csrf_token IS NOT NULL) THEN
    ...
    END IF;
  END IF;
  PERFORM "agent-os-1773547105079-c748b4c3-auth-public".check_password(
    password
  );
  password = trim(password);
  SELECT * FROM "agent-os-1773547105079-c748b4c3-user-identifiers-public".emails t
    WHERE trim(sign_up.email)::email = t.email
  INTO v_email;
  IF (NOT FOUND) THEN
    INSERT INTO "agent-os-1773547105079-c748b4c3-users-public".users
      DEFAULT VALUES
    RETURNING
      * INTO v_user;
    INSERT INTO "agent-os-1773547105079-c748b4c3-user-identifiers-public".emails (owner_id, email)
...
VOLATILE
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-auth-public".sign_up TO anonymous;
