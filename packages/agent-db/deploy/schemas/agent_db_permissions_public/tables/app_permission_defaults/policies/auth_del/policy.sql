-- Deploy: schemas/agent_db_permissions_public/tables/app_permission_defaults/policies/auth_del/policy
...
CREATE POLICY auth_del ON agent_db_permissions_public.app_permission_defaults
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
