-- Deploy: schemas/agent_db_permissions_public/tables/app_permission_defaults/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON agent_db_permissions_public.app_permission_defaults
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
