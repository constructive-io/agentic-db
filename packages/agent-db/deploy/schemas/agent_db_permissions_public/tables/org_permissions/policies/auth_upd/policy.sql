-- Deploy: schemas/agent_db_permissions_public/tables/org_permissions/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent_db_permissions_public".org_permissions
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
