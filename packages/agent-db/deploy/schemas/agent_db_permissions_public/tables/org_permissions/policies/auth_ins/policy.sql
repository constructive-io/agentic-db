-- Deploy: schemas/agent_db_permissions_public/tables/org_permissions/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON agent_db_permissions_public.org_permissions
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
