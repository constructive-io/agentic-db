-- Deploy: schemas/agent_db_permissions_public/tables/org_permission_defaults/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agent_db_permissions_public".org_permission_defaults
FOR SELECT
TO authenticated
USING (
