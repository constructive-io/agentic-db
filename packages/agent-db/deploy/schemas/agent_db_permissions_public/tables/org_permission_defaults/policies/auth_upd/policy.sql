-- Deploy: schemas/agent_db_permissions_public/tables/org_permission_defaults/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON agent_db_permissions_public.org_permission_defaults
FOR UPDATE
TO authenticated
USING (
