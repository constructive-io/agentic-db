-- Deploy: schemas/agent_db_permissions_public/tables/org_permission_defaults/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON agent_db_permissions_public.org_permission_defaults
FOR INSERT
TO authenticated
WITH CHECK (
