-- Deploy: schemas/agent_db_permissions_public/tables/app_permissions/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent_db_permissions_public".app_permissions
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
