-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/files/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent-os-1773551593867-bac64076-app-public".files
FOR DELETE
TO authenticated
USING (
