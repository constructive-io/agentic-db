-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/tasks/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent-os-1773551593867-bac64076-app-public".tasks
FOR INSERT
TO authenticated
WITH CHECK (
