-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/contact_events/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent-os-1773551593867-bac64076-app-public".contact_events
FOR SELECT
TO authenticated
USING (
