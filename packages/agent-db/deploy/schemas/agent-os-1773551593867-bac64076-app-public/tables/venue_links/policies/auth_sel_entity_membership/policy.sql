-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/venue_links/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent-os-1773551593867-bac64076-app-public".venue_links
FOR SELECT
TO authenticated
USING (
