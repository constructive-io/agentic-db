-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/tools/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent-os-1773551593867-bac64076-app-public".tools
FOR DELETE
TO authenticated
USING (
