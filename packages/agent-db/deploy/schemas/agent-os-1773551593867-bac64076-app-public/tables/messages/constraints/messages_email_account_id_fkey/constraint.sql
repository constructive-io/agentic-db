-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/messages/constraints/messages_email_account_id_fkey/constraint
...
-- requires: schemas/agent-os-1773551593867-bac64076-app-public/tables/trips/columns/embedding/column
...
ALTER TABLE "agent-os-1773551593867-bac64076-app-public".messages 
  ADD CONSTRAINT messages_email_account_id_fkey 
    ...
    REFERENCES "agent-os-1773551593867-bac64076-app-public".email_accounts (id) 
    ON DELETE CASCADE;
