-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/agent_prompts/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent-os-1773551593867-bac64076-app-public".agent_prompts
FOR SELECT
TO authenticated
USING (
