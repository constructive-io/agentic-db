-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/venue_images/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent-os-1773551593867-bac64076-app-public".venue_images
FOR SELECT
TO authenticated
USING (
