-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/execution_log/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent-os-1773551593867-bac64076-app-public".execution_log
FOR SELECT
TO authenticated
USING (
