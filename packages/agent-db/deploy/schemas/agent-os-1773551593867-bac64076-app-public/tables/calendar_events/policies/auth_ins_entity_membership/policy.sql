-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/calendar_events/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent-os-1773551593867-bac64076-app-public".calendar_events
FOR INSERT
TO authenticated
WITH CHECK (
