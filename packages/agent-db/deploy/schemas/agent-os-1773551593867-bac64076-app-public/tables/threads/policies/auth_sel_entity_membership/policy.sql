-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/threads/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent-os-1773551593867-bac64076-app-public".threads
FOR SELECT
TO authenticated
USING (
