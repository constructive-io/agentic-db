-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/expense_contacts/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent-os-1773551593867-bac64076-app-public".expense_contacts
FOR INSERT
TO authenticated
WITH CHECK (
