-- Deploy: schemas/agent-os-1773551593867-bac64076-app-public/tables/notes/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON "agent-os-1773551593867-bac64076-app-public".notes
FOR UPDATE
TO authenticated
USING (
