-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-public/tables/org_owner_grants/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agent-os-1773546821914-39f1cb9b-memberships-public".org_owner_grants
FOR SELECT
TO authenticated
USING (
