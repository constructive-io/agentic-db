-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-public/tables/org_chart_edges/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773546821914-39f1cb9b-memberships-public".org_chart_edges
FOR UPDATE
TO authenticated
USING (
