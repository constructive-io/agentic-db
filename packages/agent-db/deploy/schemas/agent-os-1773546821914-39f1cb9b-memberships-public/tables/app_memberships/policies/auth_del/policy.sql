-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-public/tables/app_memberships/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773546821914-39f1cb9b-memberships-public".app_memberships
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
