-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-public/tables/app_memberships/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773546821914-39f1cb9b-memberships-public".app_memberships
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
