-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-memberships-public/tables/org_membership_defaults/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773546821914-39f1cb9b-memberships-public".org_membership_defaults
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
