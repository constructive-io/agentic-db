-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-permissions-public/tables/app_permissions/fixtures/fix0000000161
...
INSERT INTO "agent-os-1773546821914-39f1cb9b-permissions-public".app_permissions (
  bitnum,
  name,
  description
)
