-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-permissions-public/tables/org_permissions/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773546821914-39f1cb9b-permissions-public".org_permissions
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
