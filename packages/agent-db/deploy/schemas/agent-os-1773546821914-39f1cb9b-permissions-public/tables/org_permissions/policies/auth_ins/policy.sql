-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-permissions-public/tables/org_permissions/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773546821914-39f1cb9b-permissions-public".org_permissions
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
