-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-permissions-public/tables/org_permissions/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773546821914-39f1cb9b-permissions-public".org_permissions
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
