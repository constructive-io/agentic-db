-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-permissions-public/tables/org_permissions/fixtures/fix0000000433
...
INSERT INTO "agent-os-1773546821914-39f1cb9b-permissions-public".org_permissions (
  bitnum,
  name,
  description
)
