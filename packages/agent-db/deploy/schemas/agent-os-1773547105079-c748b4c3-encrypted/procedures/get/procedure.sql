-- Deploy: schemas/agent-os-1773547105079-c748b4c3-encrypted/procedures/get/procedure
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-encrypted".get (
  owner_id uuid,
  secret_name text,
...
LANGUAGE 'plpgsql'
STABLE;
GRANT EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-encrypted".get TO authenticated;
