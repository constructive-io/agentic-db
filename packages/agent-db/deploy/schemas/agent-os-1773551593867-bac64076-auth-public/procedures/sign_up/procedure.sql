-- Deploy: schemas/agent-os-1773551593867-bac64076-auth-public/procedures/sign_up/procedure
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-auth-public".sign_up (
  email text,
  password text,
...
BEGIN
  ...
  SELECT * FROM "agent-os-1773551593867-bac64076-user-identifiers-public".emails t
    WHERE trim(sign_up.email)::email = t.email
  INTO v_email;
  IF (NOT FOUND) THEN
    INSERT INTO "agent-os-1773551593867-bac64076-users-public".users
      DEFAULT VALUES
    RETURNING
      * INTO v_user;
    INSERT INTO "agent-os-1773551593867-bac64076-user-identifiers-public".emails (owner_id, email)
...
VOLATILE
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773551593867-bac64076-auth-public".sign_up TO anonymous;
