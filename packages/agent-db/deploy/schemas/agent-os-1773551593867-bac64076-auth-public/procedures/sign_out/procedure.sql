-- Deploy: schemas/agent-os-1773551593867-bac64076-auth-public/procedures/sign_out/procedure
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-auth-public".sign_out ()
  RETURNS void
  AS $$
DECLARE
...
BEGIN
  IF (v_session_id IS NOT NULL) THEN 
    UPDATE "agent-os-1773551593867-bac64076-auth-private".session_credentials cred
      SET revoked_at = NOW()
...
VOLATILE
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773551593867-bac64076-auth-public".sign_out TO authenticated;
