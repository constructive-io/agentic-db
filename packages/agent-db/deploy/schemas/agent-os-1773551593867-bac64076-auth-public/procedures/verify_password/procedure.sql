-- Deploy: schemas/agent-os-1773551593867-bac64076-auth-public/procedures/verify_password/procedure
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-auth-public".verify_password (
  password text
)
...
BEGIN
  ...
  first_failed_password_attempt = "agent-os-1773551593867-bac64076-simple-secrets".get(v_user_id, 'first_failed_password_attempt');
  password_attempts = "agent-os-1773551593867-bac64076-simple-secrets".get(v_user_id, 'password_attempts');
  IF (
  ...
  END IF;
  IF ( "agent-os-1773551593867-bac64076-encrypted".verify(v_user_id, 'password_hash', PASSWORD) ) THEN
  ...
  ELSE
   INSERT INTO "agent-os-1773551593867-bac64076-logging-public".audit_logs 
    ...
    END IF;
    PERFORM "agent-os-1773551593867-bac64076-simple-secrets".set(v_user_id, 'password_attempts', password_attempts);
    PERFORM "agent-os-1773551593867-bac64076-simple-secrets".set(v_user_id, 'first_failed_password_attempt', first_failed_password_attempt);
    RETURN NULL;
  END IF;
END;
$$
...
STRICT
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773551593867-bac64076-auth-public".verify_password TO authenticated;
REVOKE EXECUTE ON FUNCTION "agent-os-1773551593867-bac64076-auth-public".verify_password FROM anonymous;
