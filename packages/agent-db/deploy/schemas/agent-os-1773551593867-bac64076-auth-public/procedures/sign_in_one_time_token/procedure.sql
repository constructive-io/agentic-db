-- Deploy: schemas/agent-os-1773551593867-bac64076-auth-public/procedures/sign_in_one_time_token/procedure
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-auth-public".sign_in_one_time_token (
  token text,
...
BEGIN
    ...
    FROM "agent-os-1773551593867-bac64076-auth-private".session_credentials c
    JOIN "agent-os-1773551593867-bac64076-auth-private".sessions s ON s.id = c.session_id
...
LANGUAGE 'plpgsql'
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773551593867-bac64076-auth-public".sign_in_one_time_token TO anonymous;
