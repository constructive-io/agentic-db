-- Deploy: schemas/agent-os-1773551593867-bac64076-limits-public/tables/org_limit_defaults/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773551593867-bac64076-limits-public".org_limit_defaults
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
