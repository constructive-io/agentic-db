-- Deploy: schemas/agent-os-1773551593867-bac64076-limits-public/tables/app_limits/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773551593867-bac64076-limits-public".app_limits
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
