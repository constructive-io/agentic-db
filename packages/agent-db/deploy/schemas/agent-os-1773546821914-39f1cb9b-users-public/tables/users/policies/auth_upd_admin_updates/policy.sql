-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-users-public/tables/users/policies/auth_upd_admin_updates/policy
...
CREATE POLICY auth_upd_admin_updates ON "agent-os-1773546821914-39f1cb9b-users-public".users
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
