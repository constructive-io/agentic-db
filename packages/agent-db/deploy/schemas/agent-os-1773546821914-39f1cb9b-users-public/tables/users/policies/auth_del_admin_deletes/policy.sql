-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-users-public/tables/users/policies/auth_del_admin_deletes/policy
...
CREATE POLICY auth_del_admin_deletes ON "agent-os-1773546821914-39f1cb9b-users-public".users
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
