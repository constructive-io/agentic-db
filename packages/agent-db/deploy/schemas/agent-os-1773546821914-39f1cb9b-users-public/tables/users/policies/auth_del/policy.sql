-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-users-public/tables/users/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773546821914-39f1cb9b-users-public".users
FOR DELETE
TO authenticated
USING (
