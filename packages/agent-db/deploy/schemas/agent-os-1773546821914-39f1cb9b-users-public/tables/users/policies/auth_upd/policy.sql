-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-users-public/tables/users/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773546821914-39f1cb9b-users-public".users
FOR UPDATE
TO authenticated
USING (
