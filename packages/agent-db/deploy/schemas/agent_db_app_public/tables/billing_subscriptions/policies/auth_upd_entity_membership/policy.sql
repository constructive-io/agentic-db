-- Deploy: schemas/agent_db_app_public/tables/billing_subscriptions/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON agent_db_app_public.billing_subscriptions
FOR UPDATE
TO authenticated
USING (
