-- Deploy: schemas/agent_db_app_public/tables/company_images/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".company_images
FOR INSERT
TO authenticated
WITH CHECK (
