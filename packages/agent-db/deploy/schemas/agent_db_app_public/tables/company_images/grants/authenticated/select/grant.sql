-- Deploy: schemas/agent_db_app_public/tables/company_images/grants/authenticated/select/grant
...
GRANT SELECT ON agent_db_app_public.company_images TO authenticated;
