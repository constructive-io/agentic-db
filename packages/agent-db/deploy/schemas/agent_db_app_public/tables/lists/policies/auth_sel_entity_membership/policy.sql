-- Deploy: schemas/agent_db_app_public/tables/lists/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.lists
FOR SELECT
TO authenticated
USING (
