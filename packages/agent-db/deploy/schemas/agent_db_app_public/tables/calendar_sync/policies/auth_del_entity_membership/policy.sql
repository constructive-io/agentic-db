-- Deploy: schemas/agent_db_app_public/tables/calendar_sync/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agent_db_app_public.calendar_sync
FOR DELETE
TO authenticated
USING (
