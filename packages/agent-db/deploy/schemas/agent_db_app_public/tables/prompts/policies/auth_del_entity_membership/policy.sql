-- Deploy: schemas/agent_db_app_public/tables/prompts/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agent_db_app_public.prompts
FOR DELETE
TO authenticated
USING (
