-- Deploy: schemas/agent_db_app_public/tables/contact_companies/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON agent_db_app_public.contact_companies
FOR INSERT
TO authenticated
WITH CHECK (
