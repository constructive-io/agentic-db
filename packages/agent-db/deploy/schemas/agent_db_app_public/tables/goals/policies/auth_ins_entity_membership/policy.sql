-- Deploy: schemas/agent_db_app_public/tables/goals/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".goals
FOR INSERT
TO authenticated
WITH CHECK (
