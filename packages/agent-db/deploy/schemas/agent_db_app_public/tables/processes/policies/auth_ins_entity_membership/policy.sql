-- Deploy: schemas/agent_db_app_public/tables/processes/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON agent_db_app_public.processes
FOR INSERT
TO authenticated
WITH CHECK (
