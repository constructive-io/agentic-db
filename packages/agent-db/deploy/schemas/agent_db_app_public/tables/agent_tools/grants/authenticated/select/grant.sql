-- Deploy: schemas/agent_db_app_public/tables/agent_tools/grants/authenticated/select/grant
...
GRANT SELECT ON "agent_db_app_public".agent_tools TO authenticated;
