-- Deploy: schemas/agent_db_app_public/tables/agent_tools/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".agent_tools
FOR INSERT
TO authenticated
WITH CHECK (
