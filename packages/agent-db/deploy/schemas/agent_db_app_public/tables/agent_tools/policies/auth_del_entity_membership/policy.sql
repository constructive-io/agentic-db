-- Deploy: schemas/agent_db_app_public/tables/agent_tools/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agent_db_app_public.agent_tools
FOR DELETE
TO authenticated
USING (
