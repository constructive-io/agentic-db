-- Deploy: schemas/agent_db_app_public/tables/contact_memories/grants/authenticated/select/grant
...
GRANT SELECT ON "agent_db_app_public".contact_memories TO authenticated;
