-- Deploy: schemas/agent_db_app_public/tables/ideas/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".ideas
FOR DELETE
TO authenticated
USING (
