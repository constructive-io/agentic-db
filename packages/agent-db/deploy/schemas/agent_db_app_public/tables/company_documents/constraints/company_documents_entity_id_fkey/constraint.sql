-- Deploy: schemas/agent_db_app_public/tables/company_documents/constraints/company_documents_entity_id_fkey/constraint
...
ALTER TABLE agent_db_app_public.company_documents 
  ADD CONSTRAINT company_documents_entity_id_fkey 
