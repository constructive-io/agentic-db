-- Deploy: schemas/agent_db_app_public/tables/workflow_runs/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.workflow_runs
FOR SELECT
TO authenticated
USING (
