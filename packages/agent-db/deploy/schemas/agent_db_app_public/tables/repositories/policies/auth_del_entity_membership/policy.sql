-- Deploy: schemas/agent_db_app_public/tables/repositories/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".repositories
FOR DELETE
TO authenticated
USING (
