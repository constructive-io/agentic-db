-- Deploy: schemas/agent_db_app_public/tables/repositories/grants/authenticated/select/grant
...
GRANT SELECT ON "agent_db_app_public".repositories TO authenticated;
