-- Deploy: schemas/agent_db_app_public/tables/list_items/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON agent_db_app_public.list_items
FOR UPDATE
TO authenticated
USING (
