-- Deploy: schemas/agent_db_app_public/tables/list_items/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".list_items
FOR DELETE
TO authenticated
USING (
