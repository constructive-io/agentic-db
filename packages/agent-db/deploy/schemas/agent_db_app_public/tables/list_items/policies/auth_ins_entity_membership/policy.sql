-- Deploy: schemas/agent_db_app_public/tables/list_items/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON agent_db_app_public.list_items
FOR INSERT
TO authenticated
WITH CHECK (
