-- Deploy: schemas/agent_db_app_public/tables/event_links/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON "agent_db_app_public".event_links
FOR UPDATE
TO authenticated
USING (
