-- Deploy: schemas/agent_db_app_public/tables/rules/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".rules
FOR DELETE
TO authenticated
USING (
