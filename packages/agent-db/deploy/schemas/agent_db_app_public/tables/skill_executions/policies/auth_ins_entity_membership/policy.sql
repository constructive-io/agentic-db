-- Deploy: schemas/agent_db_app_public/tables/skill_executions/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".skill_executions
FOR INSERT
TO authenticated
WITH CHECK (
