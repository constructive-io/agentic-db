-- Deploy: schemas/agent_db_app_public/tables/skill_executions/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON agent_db_app_public.skill_executions
FOR UPDATE
TO authenticated
USING (
