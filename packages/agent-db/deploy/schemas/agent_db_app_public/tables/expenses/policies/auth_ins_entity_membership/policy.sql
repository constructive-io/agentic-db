-- Deploy: schemas/agent_db_app_public/tables/expenses/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".expenses
FOR INSERT
TO authenticated
WITH CHECK (
