-- Deploy: schemas/agent_db_app_public/tables/agent_rules/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".agent_rules
FOR INSERT
TO authenticated
WITH CHECK (
