-- Deploy: schemas/agent_db_app_public/tables/agent_rules/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agent_db_app_public.agent_rules
FOR DELETE
TO authenticated
USING (
