-- Deploy: schemas/agent_db_app_public/tables/agent_rules/grants/authenticated/select/grant
...
GRANT SELECT ON agent_db_app_public.agent_rules TO authenticated;
