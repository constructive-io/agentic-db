-- Deploy: schemas/agent_db_app_public/tables/attachments/grants/authenticated/delete/grant
...
GRANT DELETE ON "agent_db_app_public".attachments TO authenticated;
