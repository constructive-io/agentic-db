-- Deploy: schemas/agent_db_app_public/tables/execution_log/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON agent_db_app_public.execution_log
FOR INSERT
TO authenticated
WITH CHECK (
