-- Deploy: schemas/agent_db_app_public/tables/goal_habits/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON agent_db_app_public.goal_habits
FOR INSERT
TO authenticated
WITH CHECK (
