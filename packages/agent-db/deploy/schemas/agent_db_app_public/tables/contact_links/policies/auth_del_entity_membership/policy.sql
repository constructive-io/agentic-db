-- Deploy: schemas/agent_db_app_public/tables/contact_links/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".contact_links
FOR DELETE
TO authenticated
USING (
