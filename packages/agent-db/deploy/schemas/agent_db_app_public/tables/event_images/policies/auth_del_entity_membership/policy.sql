-- Deploy: schemas/agent_db_app_public/tables/event_images/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".event_images
FOR DELETE
TO authenticated
USING (
