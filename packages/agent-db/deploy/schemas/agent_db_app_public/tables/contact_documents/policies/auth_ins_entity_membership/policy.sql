-- Deploy: schemas/agent_db_app_public/tables/contact_documents/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON agent_db_app_public.contact_documents
FOR INSERT
TO authenticated
WITH CHECK (
