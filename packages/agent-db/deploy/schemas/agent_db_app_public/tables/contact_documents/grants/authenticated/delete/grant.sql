-- Deploy: schemas/agent_db_app_public/tables/contact_documents/grants/authenticated/delete/grant
...
GRANT DELETE ON "agent_db_app_public".contact_documents TO authenticated;
