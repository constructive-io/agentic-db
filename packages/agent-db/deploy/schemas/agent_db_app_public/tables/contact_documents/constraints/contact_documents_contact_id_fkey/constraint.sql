-- Deploy: schemas/agent_db_app_public/tables/contact_documents/constraints/contact_documents_contact_id_fkey/constraint
...
ALTER TABLE agent_db_app_public.contact_documents 
  ADD CONSTRAINT contact_documents_contact_id_fkey 
