-- Deploy: schemas/agent_db_app_public/tables/contact_emails/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".contact_emails
FOR DELETE
TO authenticated
USING (
