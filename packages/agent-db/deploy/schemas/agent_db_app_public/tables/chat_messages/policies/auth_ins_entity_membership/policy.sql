-- Deploy: schemas/agent_db_app_public/tables/chat_messages/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".chat_messages
FOR INSERT
TO authenticated
WITH CHECK (
