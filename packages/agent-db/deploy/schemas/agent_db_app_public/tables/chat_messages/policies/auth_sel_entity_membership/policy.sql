-- Deploy: schemas/agent_db_app_public/tables/chat_messages/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.chat_messages
FOR SELECT
TO authenticated
USING (
