-- Deploy: schemas/agent_db_app_public/tables/habit_logs/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.habit_logs
FOR SELECT
TO authenticated
USING (
