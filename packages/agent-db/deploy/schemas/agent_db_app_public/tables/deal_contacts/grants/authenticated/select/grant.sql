-- Deploy: schemas/agent_db_app_public/tables/deal_contacts/grants/authenticated/select/grant
...
GRANT SELECT ON agent_db_app_public.deal_contacts TO authenticated;
