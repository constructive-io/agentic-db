-- Deploy: schemas/agent_db_app_public/tables/memories/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.memories
FOR SELECT
TO authenticated
USING (
