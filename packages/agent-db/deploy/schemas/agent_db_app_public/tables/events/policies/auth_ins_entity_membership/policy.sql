-- Deploy: schemas/agent_db_app_public/tables/events/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".events
FOR INSERT
TO authenticated
WITH CHECK (
