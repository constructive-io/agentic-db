-- Deploy: schemas/agent_db_app_public/tables/events/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agent_db_app_public.events
FOR DELETE
TO authenticated
USING (
