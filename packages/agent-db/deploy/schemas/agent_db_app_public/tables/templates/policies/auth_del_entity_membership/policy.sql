-- Deploy: schemas/agent_db_app_public/tables/templates/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agent_db_app_public.templates
FOR DELETE
TO authenticated
USING (
