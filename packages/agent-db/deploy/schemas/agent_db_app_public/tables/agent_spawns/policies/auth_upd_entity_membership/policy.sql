-- Deploy: schemas/agent_db_app_public/tables/agent_spawns/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON "agent_db_app_public".agent_spawns
FOR UPDATE
TO authenticated
USING (
