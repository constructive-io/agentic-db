-- Deploy: schemas/agent_db_app_public/tables/chunks/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".chunks
FOR DELETE
TO authenticated
USING (
