-- Deploy: schemas/agent_db_app_public/tables/company_notes/grants/authenticated/select/grant
...
GRANT SELECT ON "agent_db_app_public".company_notes TO authenticated;
