-- Deploy: schemas/agent_db_app_public/tables/scheduled_jobs/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".scheduled_jobs
FOR INSERT
TO authenticated
WITH CHECK (
