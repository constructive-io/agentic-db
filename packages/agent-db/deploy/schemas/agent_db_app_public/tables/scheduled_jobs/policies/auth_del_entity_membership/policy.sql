-- Deploy: schemas/agent_db_app_public/tables/scheduled_jobs/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agent_db_app_public.scheduled_jobs
FOR DELETE
TO authenticated
USING (
