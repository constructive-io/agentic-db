-- Deploy: schemas/agent_db_app_public/tables/context_relations/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".context_relations
FOR DELETE
TO authenticated
USING (
