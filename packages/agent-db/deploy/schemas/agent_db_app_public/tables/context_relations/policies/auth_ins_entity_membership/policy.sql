-- Deploy: schemas/agent_db_app_public/tables/context_relations/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".context_relations
FOR INSERT
TO authenticated
WITH CHECK (
