-- Deploy: schemas/agent_db_app_public/tables/context_relations/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON "agent_db_app_public".context_relations
FOR UPDATE
TO authenticated
USING (
