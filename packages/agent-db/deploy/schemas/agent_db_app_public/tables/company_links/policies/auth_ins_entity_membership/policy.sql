-- Deploy: schemas/agent_db_app_public/tables/company_links/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON agent_db_app_public.company_links
FOR INSERT
TO authenticated
WITH CHECK (
