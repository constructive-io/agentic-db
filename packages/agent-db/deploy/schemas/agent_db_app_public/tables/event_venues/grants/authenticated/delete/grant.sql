-- Deploy: schemas/agent_db_app_public/tables/event_venues/grants/authenticated/delete/grant
...
GRANT DELETE ON agent_db_app_public.event_venues TO authenticated;
