-- Deploy: schemas/agent_db_app_public/tables/event_venues/grants/authenticated/select/grant
...
GRANT SELECT ON agent_db_app_public.event_venues TO authenticated;
