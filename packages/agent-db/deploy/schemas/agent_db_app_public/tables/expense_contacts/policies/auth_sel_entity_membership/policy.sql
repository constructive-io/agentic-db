-- Deploy: schemas/agent_db_app_public/tables/expense_contacts/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.expense_contacts
FOR SELECT
TO authenticated
USING (
