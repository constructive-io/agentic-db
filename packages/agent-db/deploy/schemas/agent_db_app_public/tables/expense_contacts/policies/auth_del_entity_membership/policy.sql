-- Deploy: schemas/agent_db_app_public/tables/expense_contacts/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".expense_contacts
FOR DELETE
TO authenticated
USING (
