-- Deploy: schemas/agent_db_app_public/tables/expense_contacts/grants/authenticated/insert/grant
...
GRANT INSERT ON "agent_db_app_public".expense_contacts TO authenticated;
