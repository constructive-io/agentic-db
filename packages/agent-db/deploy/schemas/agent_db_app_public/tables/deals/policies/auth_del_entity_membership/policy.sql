-- Deploy: schemas/agent_db_app_public/tables/deals/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".deals
FOR DELETE
TO authenticated
USING (
