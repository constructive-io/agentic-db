-- Deploy: schemas/agent_db_app_public/tables/deals/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON "agent_db_app_public".deals
FOR UPDATE
TO authenticated
USING (
