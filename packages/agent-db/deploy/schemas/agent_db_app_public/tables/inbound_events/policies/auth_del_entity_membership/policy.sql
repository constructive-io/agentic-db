-- Deploy: schemas/agent_db_app_public/tables/inbound_events/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent_db_app_public".inbound_events
FOR DELETE
TO authenticated
USING (
