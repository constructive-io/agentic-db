-- Deploy: schemas/agent_db_app_public/tables/inbound_events/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".inbound_events
FOR INSERT
TO authenticated
WITH CHECK (
