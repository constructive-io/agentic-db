-- Deploy: schemas/agent_db_app_public/tables/user_settings/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent_db_app_public".user_settings
FOR SELECT
TO authenticated
USING (
