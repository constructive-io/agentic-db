-- Deploy: schemas/agent_db_app_public/tables/files/columns/created_at/alterations/alt0000001129
-- made with <3 @ launchql.com

-- requires: schemas/agent_db_app_public/schema
-- requires: schemas/agent_db_app_public/tables/files/table
-- requires: schemas/agent_db_app_public/tables/files/columns/created_at/column
