-- Deploy: schemas/agent_db_app_public/tables/agent_skills/grants/authenticated/select/grant
...
GRANT SELECT ON "agent_db_app_public".agent_skills TO authenticated;
