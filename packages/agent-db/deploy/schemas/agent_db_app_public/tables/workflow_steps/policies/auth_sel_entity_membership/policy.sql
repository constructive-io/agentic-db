-- Deploy: schemas/agent_db_app_public/tables/workflow_steps/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.workflow_steps
FOR SELECT
TO authenticated
USING (
