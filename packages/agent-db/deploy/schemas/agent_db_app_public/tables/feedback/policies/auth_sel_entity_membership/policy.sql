-- Deploy: schemas/agent_db_app_public/tables/feedback/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.feedback
FOR SELECT
TO authenticated
USING (
