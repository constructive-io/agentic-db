-- Deploy: schemas/agent_db_app_public/tables/goal_projects/grants/authenticated/select/grant
...
GRANT SELECT ON "agent_db_app_public".goal_projects TO authenticated;
