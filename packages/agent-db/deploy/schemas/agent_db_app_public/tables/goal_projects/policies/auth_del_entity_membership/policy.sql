-- Deploy: schemas/agent_db_app_public/tables/goal_projects/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agent_db_app_public.goal_projects
FOR DELETE
TO authenticated
USING (
