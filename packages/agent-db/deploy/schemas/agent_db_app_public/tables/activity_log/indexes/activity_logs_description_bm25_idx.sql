-- Deploy: schemas/agent_db_app_public/tables/activity_log/indexes/activity_logs_description_bm25_idx
...
CREATE INDEX activity_logs_description_bm25_idx ON "agent_db_app_public".activity_log USING bm25 ( description ) WITH ( text_config = english );
