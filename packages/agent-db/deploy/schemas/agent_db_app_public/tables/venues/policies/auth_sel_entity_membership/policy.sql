-- Deploy: schemas/agent_db_app_public/tables/venues/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.venues
FOR SELECT
TO authenticated
USING (
