-- Deploy: schemas/agent_db_app_public/tables/venue_links/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agent_db_app_public.venue_links
FOR DELETE
TO authenticated
USING (
