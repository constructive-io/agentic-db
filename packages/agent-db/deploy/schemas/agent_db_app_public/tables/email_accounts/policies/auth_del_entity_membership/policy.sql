-- Deploy: schemas/agent_db_app_public/tables/email_accounts/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON agent_db_app_public.email_accounts
FOR DELETE
TO authenticated
USING (
