-- Deploy: schemas/agent_db_app_public/tables/email_accounts/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".email_accounts
FOR INSERT
TO authenticated
WITH CHECK (
