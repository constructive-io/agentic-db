-- Deploy: schemas/agent_db_app_public/tables/agent_prompts/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.agent_prompts
FOR SELECT
TO authenticated
USING (
