-- Deploy: schemas/agent_db_app_public/tables/calendar_events/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".calendar_events
FOR INSERT
TO authenticated
WITH CHECK (
