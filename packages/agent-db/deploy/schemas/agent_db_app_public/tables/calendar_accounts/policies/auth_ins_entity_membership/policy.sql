-- Deploy: schemas/agent_db_app_public/tables/calendar_accounts/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent_db_app_public".calendar_accounts
FOR INSERT
TO authenticated
WITH CHECK (
