-- Deploy: schemas/agent_db_app_public/tables/calendar_accounts/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent_db_app_public".calendar_accounts
FOR SELECT
TO authenticated
USING (
