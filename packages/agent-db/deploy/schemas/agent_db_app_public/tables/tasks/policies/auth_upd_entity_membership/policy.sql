-- Deploy: schemas/agent_db_app_public/tables/tasks/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON agent_db_app_public.tasks
FOR UPDATE
TO authenticated
USING (
