-- Deploy: schemas/agent_db_app_public/tables/tasks/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON agent_db_app_public.tasks
FOR SELECT
TO authenticated
USING (
