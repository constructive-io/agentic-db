-- Deploy: schemas/agent_db_app_public/tables/project_contacts/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON agent_db_app_public.project_contacts
FOR INSERT
TO authenticated
WITH CHECK (
