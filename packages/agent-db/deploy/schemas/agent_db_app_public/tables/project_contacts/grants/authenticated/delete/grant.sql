-- Deploy: schemas/agent_db_app_public/tables/project_contacts/grants/authenticated/delete/grant
...
GRANT DELETE ON agent_db_app_public.project_contacts TO authenticated;
