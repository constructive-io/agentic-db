-- Deploy: schemas/agent_db_app_public/tables/session_archives/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON agent_db_app_public.session_archives
FOR UPDATE
TO authenticated
USING (
