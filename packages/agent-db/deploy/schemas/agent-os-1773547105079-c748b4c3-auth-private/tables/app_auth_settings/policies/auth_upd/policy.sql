-- Deploy: schemas/agent-os-1773547105079-c748b4c3-auth-private/tables/app_auth_settings/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773547105079-c748b4c3-auth-private".app_auth_settings
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
