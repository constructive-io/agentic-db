-- Deploy: schemas/agent-os-1773547105079-c748b4c3-auth-private/procedures/authenticate_strict/procedure
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-auth-private".authenticate_strict (token_str text)
    RETURNS TABLE (
        id uuid,
        user_id uuid
    )
...
SELECT
    ...
    sess.user_id
FROM
    "agent-os-1773547105079-c748b4c3-auth-private".session_credentials AS cred
    JOIN "agent-os-1773547105079-c748b4c3-auth-private".sessions AS sess ON sess.id = cred.session_id
WHERE
...
LANGUAGE 'sql' STABLE
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-auth-private".authenticate_strict TO anonymous;
GRANT EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-auth-private".authenticate_strict TO authenticated;
