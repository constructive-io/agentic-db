-- Deploy: schemas/agent_db_profiles_private/trigger_fns/app_memberships_profile_sync_tg
...
CREATE FUNCTION "agent_db_profiles_private".app_memberships_profile_sync_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
