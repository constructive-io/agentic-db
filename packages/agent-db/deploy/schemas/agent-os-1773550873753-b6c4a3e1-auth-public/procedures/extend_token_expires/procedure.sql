-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-auth-public/procedures/extend_token_expires/procedure
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-auth-public".extend_token_expires (
...
DECLARE
  ...
  v_credential "agent-os-1773550873753-b6c4a3e1-auth-private".session_credentials;
  v_session "agent-os-1773550873753-b6c4a3e1-auth-private".sessions;
BEGIN
    IF (v_token_id IS NULL) THEN 
      RETURN;
    END IF;
    SELECT cred.* FROM "agent-os-1773550873753-b6c4a3e1-auth-private".session_credentials cred
    ...
    IF (NOT FOUND) THEN 
      RETURN;
    END IF;
    SELECT sess.* FROM "agent-os-1773550873753-b6c4a3e1-auth-private".sessions sess
...
STRICT
SECURITY DEFINER;
GRANT EXECUTE ON FUNCTION "agent-os-1773550873753-b6c4a3e1-auth-public".extend_token_expires TO authenticated;
