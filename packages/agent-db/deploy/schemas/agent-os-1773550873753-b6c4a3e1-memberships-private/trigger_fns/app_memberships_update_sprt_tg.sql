-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-private/trigger_fns/app_memberships_update_sprt_tg
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-memberships-private".app_memberships_update_sprt_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    v_num_updated int;
