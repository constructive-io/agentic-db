-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-private/trigger_fns/app_grants_apply_tg
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-memberships-private".app_grants_apply_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
