-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-private/trigger_fns/org_memberships_utg
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-memberships-private".org_memberships_utg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
