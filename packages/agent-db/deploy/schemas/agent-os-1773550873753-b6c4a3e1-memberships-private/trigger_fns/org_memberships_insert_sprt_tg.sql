-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-private/trigger_fns/org_memberships_insert_sprt_tg
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-memberships-private".org_memberships_insert_sprt_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
