-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-private/trigger_fns/membership_mbr_create
...
-- requires: schemas/agent-os-1773550873753-b6c4a3e1-permissions-public/procedures/org_permissions_get_mask_by_names/procedure



CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-memberships-private".membership_mbr_create ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
...
BEGIN
    ...
    ELSEIF (owner_id IS NOT NULL) THEN 
        ...
        INSERT INTO "agent-os-1773550873753-b6c4a3e1-memberships-public".org_membership_defaults
        ( entity_id  ) -- is_approved, etc., defaults from table itself
        VALUES ( NEW.id );
        INSERT INTO "agent-os-1773550873753-b6c4a3e1-permissions-public".org_permission_defaults 
            (permissions, entity_id)
        VALUES 
        (
            "agent-os-1773550873753-b6c4a3e1-permissions-public".org_permissions_get_mask_by_names(
