-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-private/tables/org_memberships_sprt/indexes/org_memberships_sprts_actor_id_entity_id_idx
...
CREATE UNIQUE INDEX org_memberships_sprts_actor_id_entity_id_idx ON "agent-os-1773550873753-b6c4a3e1-memberships-private".org_memberships_sprt USING BTREE ( actor_id, entity_id ) INCLUDE ( permissions );
