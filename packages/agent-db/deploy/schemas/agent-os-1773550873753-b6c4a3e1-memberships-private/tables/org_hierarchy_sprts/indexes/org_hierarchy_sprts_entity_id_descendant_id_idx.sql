-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-memberships-private/tables/org_hierarchy_sprts/indexes/org_hierarchy_sprts_entity_id_descendant_id_idx
...
CREATE INDEX org_hierarchy_sprts_entity_id_descendant_id_idx ON "agent-os-1773550873753-b6c4a3e1-memberships-private".org_hierarchy_sprts USING BTREE ( entity_id, descendant_id );
