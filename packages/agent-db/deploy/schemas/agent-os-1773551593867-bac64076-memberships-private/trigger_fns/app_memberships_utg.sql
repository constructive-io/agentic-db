-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-private/trigger_fns/app_memberships_utg
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-memberships-private".app_memberships_utg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
