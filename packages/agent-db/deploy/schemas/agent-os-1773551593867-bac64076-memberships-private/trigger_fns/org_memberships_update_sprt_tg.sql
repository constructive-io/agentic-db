-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-private/trigger_fns/org_memberships_update_sprt_tg
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-memberships-private".org_memberships_update_sprt_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    v_num_updated int;
...
BEGIN
    ...
    ELSE 
        SELECT EXISTS (
            SELECT 1 FROM "agent-os-1773551593867-bac64076-memberships-private".app_memberships_sprt
            WHERE actor_id = NEW.actor_id
