-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-private/trigger_fns/app_grants_apply_tg
...
CREATE FUNCTION "agent-os-1773551593867-bac64076-memberships-private".app_grants_apply_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
