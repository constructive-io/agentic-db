-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-private/trigger_fns/org_membership_validate_not_in_hierarchy_tg
-- made with <3 @ launchql.com

-- requires: schemas/agent-os-1773551593867-bac64076-memberships-private/schema


CREATE FUNCTION "agent-os-1773551593867-bac64076-memberships-private".org_membership_validate_not_in_hierarchy_tg() RETURNS TRIGGER AS $_PGFN_$
                ...
                BEGIN
                    ...
                    IF (v_old_is_active IS TRUE AND v_new_is_active IS NOT TRUE) THEN
                        ...
                        SELECT EXISTS (
                            SELECT 1
                            FROM "agent-os-1773551593867-bac64076-memberships-public".org_chart_edges e
