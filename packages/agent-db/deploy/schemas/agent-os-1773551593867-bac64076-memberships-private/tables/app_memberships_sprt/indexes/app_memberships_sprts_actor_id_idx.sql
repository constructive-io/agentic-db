-- Deploy: schemas/agent-os-1773551593867-bac64076-memberships-private/tables/app_memberships_sprt/indexes/app_memberships_sprts_actor_id_idx
...
CREATE UNIQUE INDEX app_memberships_sprts_actor_id_idx ON "agent-os-1773551593867-bac64076-memberships-private".app_memberships_sprt USING BTREE ( actor_id ) INCLUDE ( permissions, is_owner, is_admin );
