-- Deploy: schemas/agent-os-1773551593867-bac64076-profiles-public/tables/org_profiles/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773551593867-bac64076-profiles-public".org_profiles
FOR INSERT
TO authenticated
WITH CHECK (
