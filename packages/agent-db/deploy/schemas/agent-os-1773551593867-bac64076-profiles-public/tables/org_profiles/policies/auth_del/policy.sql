-- Deploy: schemas/agent-os-1773551593867-bac64076-profiles-public/tables/org_profiles/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773551593867-bac64076-profiles-public".org_profiles
FOR DELETE
TO authenticated
USING (
