-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-app-public/tables/companies/policies/auth_del_entity_membership/policy
...
CREATE POLICY auth_del_entity_membership ON "agent-os-1773546821914-39f1cb9b-app-public".companies
FOR DELETE
TO authenticated
USING (
