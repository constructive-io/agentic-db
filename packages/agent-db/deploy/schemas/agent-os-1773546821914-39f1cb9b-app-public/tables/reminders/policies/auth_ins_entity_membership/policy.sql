-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-app-public/tables/reminders/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent-os-1773546821914-39f1cb9b-app-public".reminders
FOR INSERT
TO authenticated
WITH CHECK (
