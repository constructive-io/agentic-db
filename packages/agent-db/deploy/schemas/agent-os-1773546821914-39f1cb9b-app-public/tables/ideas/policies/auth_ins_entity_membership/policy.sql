-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-app-public/tables/ideas/policies/auth_ins_entity_membership/policy
...
CREATE POLICY auth_ins_entity_membership ON "agent-os-1773546821914-39f1cb9b-app-public".ideas
FOR INSERT
TO authenticated
WITH CHECK (
