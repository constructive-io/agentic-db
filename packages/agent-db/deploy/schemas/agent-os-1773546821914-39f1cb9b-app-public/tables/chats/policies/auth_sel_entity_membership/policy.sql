-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-app-public/tables/chats/policies/auth_sel_entity_membership/policy
...
CREATE POLICY auth_sel_entity_membership ON "agent-os-1773546821914-39f1cb9b-app-public".chats
FOR SELECT
TO authenticated
USING (
