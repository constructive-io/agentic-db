-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-app-public/tables/agents/grants/authenticated/select/grant
...
GRANT SELECT ON "agent-os-1773546821914-39f1cb9b-app-public".agents TO authenticated;
