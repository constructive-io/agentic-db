-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-app-public/tables/skill_executions/policies/auth_upd_entity_membership/policy
...
CREATE POLICY auth_upd_entity_membership ON "agent-os-1773546821914-39f1cb9b-app-public".skill_executions
FOR UPDATE
TO authenticated
USING (
