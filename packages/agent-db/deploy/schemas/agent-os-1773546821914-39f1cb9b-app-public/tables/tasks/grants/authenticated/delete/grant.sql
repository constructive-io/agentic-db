-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-app-public/tables/tasks/grants/authenticated/delete/grant
...
GRANT DELETE ON "agent-os-1773546821914-39f1cb9b-app-public".tasks TO authenticated;
