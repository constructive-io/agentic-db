-- Deploy: schemas/agent_db_memberships_public/tables/org_admin_grants/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON agent_db_memberships_public.org_admin_grants
FOR INSERT
TO authenticated
WITH CHECK (
