-- Deploy: schemas/agent_db_memberships_public/tables/org_admin_grants/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON agent_db_memberships_public.org_admin_grants
FOR SELECT
TO authenticated
USING (
