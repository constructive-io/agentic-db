-- Deploy: schemas/agent_db_memberships_public/tables/app_owner_grants/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent_db_memberships_public".app_owner_grants
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
