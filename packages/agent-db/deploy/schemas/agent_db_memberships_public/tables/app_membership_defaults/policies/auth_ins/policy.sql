-- Deploy: schemas/agent_db_memberships_public/tables/app_membership_defaults/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent_db_memberships_public".app_membership_defaults
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
