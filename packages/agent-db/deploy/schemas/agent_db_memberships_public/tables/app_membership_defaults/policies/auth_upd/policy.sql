-- Deploy: schemas/agent_db_memberships_public/tables/app_membership_defaults/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent_db_memberships_public".app_membership_defaults
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
