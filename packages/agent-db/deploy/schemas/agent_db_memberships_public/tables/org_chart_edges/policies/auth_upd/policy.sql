-- Deploy: schemas/agent_db_memberships_public/tables/org_chart_edges/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent_db_memberships_public".org_chart_edges
FOR UPDATE
TO authenticated
USING (
