-- Deploy: schemas/agent_db_memberships_public/tables/org_chart_edges/policies/auth_del/policy
...
CREATE POLICY auth_del ON agent_db_memberships_public.org_chart_edges
FOR DELETE
TO authenticated
USING (
