-- Deploy: schemas/agent_db_memberships_public/tables/app_memberships/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON agent_db_memberships_public.app_memberships
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
