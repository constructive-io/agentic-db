-- Deploy: schemas/agent_db_memberships_public/tables/org_memberships/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON agent_db_memberships_public.org_memberships
FOR UPDATE
TO authenticated
USING (
