-- Deploy: schemas/agent_db_memberships_public/tables/org_memberships/policies/auth_del/policy
...
CREATE POLICY auth_del ON agent_db_memberships_public.org_memberships
FOR DELETE
TO authenticated
USING (
