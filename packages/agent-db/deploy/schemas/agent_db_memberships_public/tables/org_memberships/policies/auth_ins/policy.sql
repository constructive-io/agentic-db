-- Deploy: schemas/agent_db_memberships_public/tables/org_memberships/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON agent_db_memberships_public.org_memberships
FOR INSERT
TO authenticated
WITH CHECK (
