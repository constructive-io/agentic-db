-- Deploy: schemas/agent-os-1773547105079-c748b4c3-permissions-public/tables/org_permission_defaults/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773547105079-c748b4c3-permissions-public".org_permission_defaults
FOR INSERT
TO authenticated
WITH CHECK (
