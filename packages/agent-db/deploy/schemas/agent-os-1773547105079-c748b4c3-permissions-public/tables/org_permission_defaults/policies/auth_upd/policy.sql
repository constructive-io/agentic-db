-- Deploy: schemas/agent-os-1773547105079-c748b4c3-permissions-public/tables/org_permission_defaults/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773547105079-c748b4c3-permissions-public".org_permission_defaults
FOR UPDATE
TO authenticated
USING (
