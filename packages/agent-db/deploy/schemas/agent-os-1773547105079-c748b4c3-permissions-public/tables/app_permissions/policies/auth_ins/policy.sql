-- Deploy: schemas/agent-os-1773547105079-c748b4c3-permissions-public/tables/app_permissions/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773547105079-c748b4c3-permissions-public".app_permissions
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
