-- Deploy: schemas/agent-os-1773547105079-c748b4c3-permissions-public/tables/org_permissions/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773547105079-c748b4c3-permissions-public".org_permissions
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
