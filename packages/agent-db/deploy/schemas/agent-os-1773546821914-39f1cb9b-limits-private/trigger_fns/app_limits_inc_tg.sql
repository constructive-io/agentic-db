-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-limits-private/trigger_fns/app_limits_inc_tg
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-limits-private".app_limits_inc_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    limit_ok boolean;
