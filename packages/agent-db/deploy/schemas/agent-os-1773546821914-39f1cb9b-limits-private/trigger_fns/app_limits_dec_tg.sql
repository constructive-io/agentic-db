-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-limits-private/trigger_fns/app_limits_dec_tg
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-limits-private".app_limits_dec_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    actor_id uuid;
