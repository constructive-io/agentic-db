-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-limits-private/procedures/org_limits_dec/procedure
...
CREATE FUNCTION "agent-os-1773546821914-39f1cb9b-limits-private".org_limits_dec (
    limitname citext,
    entity_id uuid,
