-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-limits-private/trigger_fns/app_limits_upd_tg
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-limits-private".app_limits_upd_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    limit_ok boolean;
...
BEGIN
    ...
    ELSIF (TG_NARGS = 2) THEN 
        ...
        PERFORM "agent-os-1773550873753-b6c4a3e1-limits-private".app_limits_dec(
            limitname, old_actor_id
        );
        limit_ok = "agent-os-1773550873753-b6c4a3e1-limits-private".app_limits_inc(
