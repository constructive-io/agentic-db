-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-public/procedures/org_get_subordinates/procedure
-- made with <3 @ launchql.com

-- requires: schemas/agent-os-1773547105079-c748b4c3-memberships-public/schema


CREATE FUNCTION "agent-os-1773547105079-c748b4c3-memberships-public".org_get_subordinates(
  IN p_entity_id uuid,
  IN p_user_id uuid,
  IN p_max_depth int DEFAULT NULL
        ...
        BEGIN
            ...
            FROM "agent-os-1773547105079-c748b4c3-memberships-private".org_hierarchy_sprts h
