-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-public/tables/org_owner_grants/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agent-os-1773547105079-c748b4c3-memberships-public".org_owner_grants
FOR SELECT
TO authenticated
USING (
