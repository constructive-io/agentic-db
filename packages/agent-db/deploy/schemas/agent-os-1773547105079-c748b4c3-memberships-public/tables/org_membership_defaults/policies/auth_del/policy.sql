-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-public/tables/org_membership_defaults/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773547105079-c748b4c3-memberships-public".org_membership_defaults
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
