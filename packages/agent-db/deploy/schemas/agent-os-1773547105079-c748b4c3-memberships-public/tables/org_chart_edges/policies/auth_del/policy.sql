-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-public/tables/org_chart_edges/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773547105079-c748b4c3-memberships-public".org_chart_edges
FOR DELETE
TO authenticated
USING (
