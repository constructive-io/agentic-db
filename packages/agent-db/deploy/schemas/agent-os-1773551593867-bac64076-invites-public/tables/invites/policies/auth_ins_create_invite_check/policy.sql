-- Deploy: schemas/agent-os-1773551593867-bac64076-invites-public/tables/invites/policies/auth_ins_create_invite_check/policy
...
CREATE POLICY auth_ins_create_invite_check ON "agent-os-1773551593867-bac64076-invites-public".invites
AS RESTRICTIVE
FOR INSERT
TO authenticated
WITH CHECK (
