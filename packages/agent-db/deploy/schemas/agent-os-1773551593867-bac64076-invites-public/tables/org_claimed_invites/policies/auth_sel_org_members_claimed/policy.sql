-- Deploy: schemas/agent-os-1773551593867-bac64076-invites-public/tables/org_claimed_invites/policies/auth_sel_org_members_claimed/policy
...
CREATE POLICY auth_sel_org_members_claimed ON "agent-os-1773551593867-bac64076-invites-public".org_claimed_invites
FOR SELECT
TO authenticated
USING (
