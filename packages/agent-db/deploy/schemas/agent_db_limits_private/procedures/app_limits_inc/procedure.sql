-- Deploy: schemas/agent_db_limits_private/procedures/app_limits_inc/procedure
...
CREATE FUNCTION "agent_db_limits_private".app_limits_inc (
    limitname citext,
...
BEGIN
    ...
    END IF;
    SELECT * FROM "agent_db_limits_public".app_limits l
        WHERE l.name = limitname
        AND l.actor_id = app_limits_inc.actor_id
    INTO rec;
