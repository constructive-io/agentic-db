-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-limits-public/tables/app_limits/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agent-os-1773546821914-39f1cb9b-limits-public".app_limits
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
