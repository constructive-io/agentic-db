-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-limits-public/tables/app_limits/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773546821914-39f1cb9b-limits-public".app_limits
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
