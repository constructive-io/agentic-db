-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-limits-public/tables/app_limits/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773546821914-39f1cb9b-limits-public".app_limits
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
