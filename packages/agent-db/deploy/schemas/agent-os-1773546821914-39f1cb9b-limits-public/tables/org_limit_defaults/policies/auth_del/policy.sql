-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-limits-public/tables/org_limit_defaults/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773546821914-39f1cb9b-limits-public".org_limit_defaults
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
