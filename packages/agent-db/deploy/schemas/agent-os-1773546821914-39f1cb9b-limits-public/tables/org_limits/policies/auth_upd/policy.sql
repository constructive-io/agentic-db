-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-limits-public/tables/org_limits/policies/auth_upd/policy
...
CREATE POLICY auth_upd ON "agent-os-1773546821914-39f1cb9b-limits-public".org_limits
FOR UPDATE
TO authenticated
USING (
