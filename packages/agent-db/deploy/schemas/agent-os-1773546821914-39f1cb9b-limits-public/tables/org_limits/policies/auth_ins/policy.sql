-- Deploy: schemas/agent-os-1773546821914-39f1cb9b-limits-public/tables/org_limits/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773546821914-39f1cb9b-limits-public".org_limits
FOR INSERT
TO authenticated
WITH CHECK (
