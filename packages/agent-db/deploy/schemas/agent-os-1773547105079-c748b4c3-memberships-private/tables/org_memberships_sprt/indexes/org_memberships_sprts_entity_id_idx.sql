-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-private/tables/org_memberships_sprt/indexes/org_memberships_sprts_entity_id_idx
...
CREATE INDEX org_memberships_sprts_entity_id_idx ON "agent-os-1773547105079-c748b4c3-memberships-private".org_memberships_sprt USING BTREE ( entity_id ) INCLUDE ( permissions, is_owner, is_admin );
