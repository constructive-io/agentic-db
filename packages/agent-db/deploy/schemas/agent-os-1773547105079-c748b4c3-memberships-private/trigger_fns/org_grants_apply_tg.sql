-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-private/trigger_fns/org_grants_apply_tg
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-memberships-private".org_grants_apply_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
