-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-private/trigger_fns/app_memberships_sprt_to_org_memberships_sprt_tg
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-memberships-private".app_memberships_sprt_to_org_memberships_sprt_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
    ...
    IF (TG_OP = 'DELETE') THEN
        BEGIN
            DELETE FROM "agent-os-1773547105079-c748b4c3-memberships-private".org_memberships_sprt 
                WHERE actor_id = OLD.actor_id;
            DELETE FROM "agent-os-1773547105079-c748b4c3-memberships-public".org_members 
                WHERE actor_id = OLD.actor_id;
    ...
    IF (TG_OP = 'INSERT') THEN
        BEGIN
            ...
            FROM "agent-os-1773547105079-c748b4c3-memberships-public".org_memberships m
