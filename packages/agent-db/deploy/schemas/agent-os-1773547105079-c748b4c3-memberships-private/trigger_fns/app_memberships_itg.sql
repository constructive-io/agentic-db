-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-private/trigger_fns/app_memberships_itg
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-memberships-private".app_memberships_itg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    bitlen int = bit_length(NEW.permissions);
    defaults bit varying;
    memdefs "agent-os-1773547105079-c748b4c3-memberships-public".app_membership_defaults;
BEGIN
    SELECT * FROM
        "agent-os-1773547105079-c748b4c3-memberships-public".app_membership_defaults t 
    LIMIT 1 
    INTO memdefs;
    IF (FOUND) THEN 
    ...
    SELECT permissions FROM
        "agent-os-1773547105079-c748b4c3-permissions-public".app_permission_defaults t 
    LIMIT 1 
    INTO defaults;
    IF (NOT FOUND) THEN 
