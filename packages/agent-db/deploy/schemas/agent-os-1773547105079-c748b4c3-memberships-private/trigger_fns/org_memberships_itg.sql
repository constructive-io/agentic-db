-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-private/trigger_fns/org_memberships_itg
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-memberships-private".org_memberships_itg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    bitlen int = bit_length(NEW.permissions);
    defaults bit varying;
    memdefs "agent-os-1773547105079-c748b4c3-memberships-public".org_membership_defaults;
BEGIN
    SELECT * FROM
        "agent-os-1773547105079-c748b4c3-memberships-public".org_membership_defaults t 
    ...
    SELECT permissions FROM
        "agent-os-1773547105079-c748b4c3-permissions-public".org_permission_defaults t 
        WHERE t.entity_id = NEW.entity_id
    INTO defaults;
    IF (NOT FOUND) THEN 
