-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-private/trigger_fns/app_admin_grants_apply_tg
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-memberships-private".app_admin_grants_apply_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
