-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-private/trigger_fns/app_memberships_delete_sprt_tg
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-memberships-private".app_memberships_delete_sprt_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    v_num_updated int;
