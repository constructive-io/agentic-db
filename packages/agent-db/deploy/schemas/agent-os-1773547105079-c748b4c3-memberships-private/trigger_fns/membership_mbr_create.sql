-- Deploy: schemas/agent-os-1773547105079-c748b4c3-memberships-private/trigger_fns/membership_mbr_create
...
-- requires: schemas/agent-os-1773547105079-c748b4c3-permissions-public/procedures/org_permissions_get_mask_by_names/procedure



CREATE FUNCTION "agent-os-1773547105079-c748b4c3-memberships-private".membership_mbr_create ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
...
BEGIN
    ...
    ELSEIF (owner_id IS NOT NULL) THEN 
        ...
        INSERT INTO "agent-os-1773547105079-c748b4c3-memberships-public".org_membership_defaults
        ( entity_id  ) -- is_approved, etc., defaults from table itself
        VALUES ( NEW.id );
        INSERT INTO "agent-os-1773547105079-c748b4c3-permissions-public".org_permission_defaults 
            (permissions, entity_id)
        VALUES 
        (
            "agent-os-1773547105079-c748b4c3-permissions-public".org_permissions_get_mask_by_names(
