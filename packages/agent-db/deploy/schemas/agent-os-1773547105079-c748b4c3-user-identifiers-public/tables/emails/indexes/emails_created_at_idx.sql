-- Deploy: schemas/agent-os-1773547105079-c748b4c3-user-identifiers-public/tables/emails/indexes/emails_created_at_idx
...
CREATE INDEX emails_created_at_idx ON "agent-os-1773547105079-c748b4c3-user-identifiers-public".emails ( created_at );
