-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-status-private/trigger_fns/tg_achv_tgl_bool
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-status-private".tg_achv_tgl_bool ()
  RETURNS TRIGGER
  AS $$
DECLARE
  is_true boolean;
...
LANGUAGE 'plpgsql'
VOLATILE;
GRANT EXECUTE ON FUNCTION "agent-os-1773550873753-b6c4a3e1-status-private".tg_achv_tgl_bool TO authenticated;
