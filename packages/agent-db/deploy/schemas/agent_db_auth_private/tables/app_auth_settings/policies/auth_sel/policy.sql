-- Deploy: schemas/agent_db_auth_private/tables/app_auth_settings/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON agent_db_auth_private.app_auth_settings
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
