-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-encrypted/procedures/del/procedure
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-encrypted".del(
  owner_id uuid,
  secret_name text
)
  RETURNS void
  AS $$
BEGIN
  DELETE FROM "agent-os-1773550873753-b6c4a3e1-encrypted".encrypted_secrets s
...
LANGUAGE 'plpgsql'
VOLATILE;
GRANT EXECUTE ON FUNCTION "agent-os-1773550873753-b6c4a3e1-encrypted".del(uuid,text) TO authenticated;
GRANT EXECUTE ON FUNCTION "agent-os-1773550873753-b6c4a3e1-encrypted".del(uuid,text[]) TO authenticated;
