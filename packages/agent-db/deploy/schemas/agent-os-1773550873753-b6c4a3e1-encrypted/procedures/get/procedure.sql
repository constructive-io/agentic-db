-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-encrypted/procedures/get/procedure
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-encrypted".get (
  owner_id uuid,
  secret_name text,
...
LANGUAGE 'plpgsql'
STABLE;
GRANT EXECUTE ON FUNCTION "agent-os-1773550873753-b6c4a3e1-encrypted".get TO authenticated;
