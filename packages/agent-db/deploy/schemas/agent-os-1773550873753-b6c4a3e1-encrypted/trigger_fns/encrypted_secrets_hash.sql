-- Deploy: schemas/agent-os-1773550873753-b6c4a3e1-encrypted/trigger_fns/encrypted_secrets_hash
...
CREATE FUNCTION "agent-os-1773550873753-b6c4a3e1-encrypted".encrypted_secrets_hash ()
RETURNS TRIGGER
AS $CODEZ$
BEGIN
