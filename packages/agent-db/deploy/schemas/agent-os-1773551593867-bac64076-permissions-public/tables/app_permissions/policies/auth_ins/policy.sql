-- Deploy: schemas/agent-os-1773551593867-bac64076-permissions-public/tables/app_permissions/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773551593867-bac64076-permissions-public".app_permissions
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
