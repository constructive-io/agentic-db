-- Deploy: schemas/agent-os-1773551593867-bac64076-permissions-public/tables/app_permissions/policies/auth_del/policy
...
CREATE POLICY auth_del ON "agent-os-1773551593867-bac64076-permissions-public".app_permissions
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
