-- Deploy: schemas/agent-os-1773551593867-bac64076-permissions-public/tables/org_permission_defaults/policies/auth_sel/policy
...
CREATE POLICY auth_sel ON "agent-os-1773551593867-bac64076-permissions-public".org_permission_defaults
FOR SELECT
TO authenticated
USING (
