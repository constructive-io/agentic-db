-- Deploy: schemas/agent-os-1773551593867-bac64076-permissions-public/tables/app_permission_defaults/policies/auth_ins/policy
...
CREATE POLICY auth_ins ON "agent-os-1773551593867-bac64076-permissions-public".app_permission_defaults
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
