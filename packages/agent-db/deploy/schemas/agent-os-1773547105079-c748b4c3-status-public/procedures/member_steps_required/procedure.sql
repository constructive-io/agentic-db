-- Deploy: schemas/agent-os-1773547105079-c748b4c3-status-public/procedures/member_steps_required/procedure
...
CREATE FUNCTION "agent-os-1773547105079-c748b4c3-status-public".member_steps_required (
    vlevel text,
    ventity_id uuid,
    vrole_id uuid DEFAULT jwt_public.current_user_id()
)
  RETURNS SETOF "agent-os-1773547105079-c748b4c3-status-public".org_level_requirements
AS $CODEZ$
BEGIN
  RETURN QUERY
  SELECT 
    ...
    FROM
      "agent-os-1773547105079-c748b4c3-status-public".org_level_requirements 
    FULL OUTER JOIN "agent-os-1773547105079-c748b4c3-status-public".org_achievements ON (
    ...
    JOIN "agent-os-1773547105079-c748b4c3-status-public".org_levels ON (org_level_requirements.level = org_levels.name)
  WHERE
...
GRANT EXECUTE ON FUNCTION "agent-os-1773547105079-c748b4c3-status-public".member_steps_required TO authenticated;
