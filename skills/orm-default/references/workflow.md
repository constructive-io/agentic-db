...
db.workflow.create({ data: { entityId: '<value>', name: '<value>', description: '<value>', triggerType: '<value>', triggerConfig: '<value>', isActive: '<value>', tags: '<value>' }, select: { id: true } }).execute()
...
const item = await db.workflow.create({
  data: { entityId: 'value', name: 'value', description: 'value', triggerType: 'value', triggerConfig: 'value', isActive: 'value', tags: 'value' },
  select: { id: true }
}).execute();
```
