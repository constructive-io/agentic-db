...
db.notification.create({ data: { entityId: '<value>', title: '<value>', body: '<value>', type: '<value>', priority: '<value>', readAt: '<value>', actionUrl: '<value>', sourceEntityId: '<value>', sourceEntityType: '<value>' }, select: { id: true } }).execute()
