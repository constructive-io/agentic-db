---
name: cli-default
description: CLI tool (agentic-db) for the default API — provides CRUD commands for 108 tables and 38 custom operations
---
...
CLI tool (agentic-db) for the default API — provides CRUD commands for 108 tables and 38 custom operations
...
agentic-db api create --<field> <value>

# Non-interactive mode (skip all prompts, use flags only)
agentic-db --no-tty api list
```
...
```bash
agentic-db --no-tty api create --<field> <value>
```
