...
agentic-db image create --url <String> [--meta <JSON>] [--altText <String>] [--caption <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>]
agentic-db image update --id <UUID> [--url <String>] [--meta <JSON>] [--altText <String>] [--caption <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>]
