...
agentic-db contact-link create --url <String> --contactId <UUID> [--title <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>]
agentic-db contact-link update --id <UUID> [--title <String>] [--url <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>] [--contactId <UUID>]
