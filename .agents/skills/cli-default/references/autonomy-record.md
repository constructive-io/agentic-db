...
agentic-db autonomy-record create --title <String> [--recordType <String>] [--content <String>] [--status <String>] [--priority <Int>] [--source <String>] [--context <JSON>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>]
agentic-db autonomy-record update --id <UUID> [--title <String>] [--recordType <String>] [--content <String>] [--status <String>] [--priority <Int>] [--source <String>] [--context <JSON>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>]
