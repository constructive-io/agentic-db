...
agentic-db place create --name <String> [--address <String>] [--description <String>] [--category <String>] [--rating <BigFloat>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>] [--locationGeo <GeographyInterface>]
agentic-db place update --id <UUID> [--name <String>] [--address <String>] [--description <String>] [--category <String>] [--rating <BigFloat>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>] [--locationGeo <GeographyInterface>]
