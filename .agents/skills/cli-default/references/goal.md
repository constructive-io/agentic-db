...
agentic-db goal create --title <String> [--description <String>] [--status <String>] [--targetDate <Datetime>] [--progress <BigFloat>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>]
agentic-db goal update --id <UUID> [--title <String>] [--description <String>] [--status <String>] [--targetDate <Datetime>] [--progress <BigFloat>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>]
