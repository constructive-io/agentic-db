...
agentic-db venue-link create --url <String> --venueId <UUID> [--title <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>]
agentic-db venue-link update --id <UUID> [--title <String>] [--url <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>] [--venueId <UUID>]
