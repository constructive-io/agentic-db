...
agentic-db memory create --title <String> [--content <String>] [--location <String>] [--occurredAt <Datetime>] [--mood <String>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>] [--locationGeo <GeographyInterface>] [--agentId <UUID>]
agentic-db memory update --id <UUID> [--title <String>] [--content <String>] [--location <String>] [--occurredAt <Datetime>] [--mood <String>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>] [--locationGeo <GeographyInterface>] [--agentId <UUID>]
