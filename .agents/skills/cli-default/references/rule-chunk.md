...
agentic-db rule-chunk create --entityId <UUID> --chunkIndex <Int> --content <String> --ruleId <UUID> [--embeddingText <String>] [--embedding <Vector>]
agentic-db rule-chunk update --id <UUID> [--entityId <UUID>] [--chunkIndex <Int>] [--content <String>] [--embeddingText <String>] [--embedding <Vector>] [--ruleId <UUID>]
