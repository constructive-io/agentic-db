...
```bash
agentic-db copy-template-to-blueprint --input.clientMutationId <String> --input.templateId <UUID> --input.databaseId <UUID> --input.ownerId <UUID> --input.nameOverride <String> --input.displayNameOverride <String>
```
