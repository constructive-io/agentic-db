...
agentic-db event-link create --url <String> --eventId <UUID> [--title <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>]
agentic-db event-link update --id <UUID> [--title <String>] [--url <String>] [--embedding <Vector>] [--embeddingUpdatedAt <Datetime>] [--eventId <UUID>]
