...
agentic-db project create --entityId <UUID> --name <String> [--description <String>] [--status <String>] [--startDate <Datetime>] [--dueDate <Datetime>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>]
agentic-db project update --id <UUID> [--entityId <UUID>] [--name <String>] [--description <String>] [--status <String>] [--startDate <Datetime>] [--dueDate <Datetime>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>]
