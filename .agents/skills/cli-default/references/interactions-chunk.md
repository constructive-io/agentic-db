...
agentic-db interactions-chunk create --entityId <UUID> --interactionsId <UUID> --content <String> --interactionId <UUID> [--chunkIndex <Int>] [--embedding <Vector>] [--metadata <JSON>]
agentic-db interactions-chunk update --id <UUID> [--entityId <UUID>] [--interactionsId <UUID>] [--content <String>] [--chunkIndex <Int>] [--embedding <Vector>] [--metadata <JSON>] [--interactionId <UUID>]
