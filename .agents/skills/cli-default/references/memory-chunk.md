...
agentic-db memory-chunk create --entityId <UUID> --chunkIndex <Int> --content <String> --memoryId <UUID> [--embeddingText <String>] [--embedding <Vector>]
agentic-db memory-chunk update --id <UUID> [--entityId <UUID>] [--chunkIndex <Int>] [--content <String>] [--embeddingText <String>] [--embedding <Vector>] [--memoryId <UUID>]
