...
agentic-db company create --entityId <UUID> --name <String> [--domain <String>] [--industry <String>] [--description <String>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>] [--mainImageId <UUID>]
agentic-db company update --id <UUID> [--entityId <UUID>] [--name <String>] [--domain <String>] [--industry <String>] [--description <String>] [--tags <String>] [--embeddingText <String>] [--embedding <Vector>] [--mainImageId <UUID>]
