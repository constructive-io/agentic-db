...
agentic-db runtime-state-dependency create --runtimeStateId <UUID> --entityId <UUID>
agentic-db runtime-state-dependency update --id <UUID> [--runtimeStateId <UUID>] [--entityId <UUID>]
