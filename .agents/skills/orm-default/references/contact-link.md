...
db.contactLink.create({ data: { title: '<String>', url: '<String>', embedding: '<Vector>', embeddingUpdatedAt: '<Datetime>', contactId: '<UUID>', embeddingVectorDistance: '<Float>', searchScore: '<Float>' }, select: { id: true } }).execute()
...
const item = await db.contactLink.create({
  data: { title: '<String>', url: '<String>', embedding: '<Vector>', embeddingUpdatedAt: '<Datetime>', contactId: '<UUID>', embeddingVectorDistance: '<Float>', searchScore: '<Float>' },
  select: { id: true }
}).execute();
```
