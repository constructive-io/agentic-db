...
agentic-db contact-company delete --id <value>
```
...
### Update a contactCompany

```bash
agentic-db contact-company update --id <value> --contactId "new-value"
```
