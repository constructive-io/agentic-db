/**
 * CLI commands for CalendarAttendee
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<CalendarAttendeeSelect, CalendarAttendeeFilter, CalendarAttendeeOrderBy> & {
        select: CalendarAttendeeSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.calendarAttendee.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<CalendarAttendeeSelect, CalendarAttendeeFilter, CalendarAttendeeOrderBy> & {
        select: CalendarAttendeeSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.calendarAttendee.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateCalendarAttendeeInput['calendarAttendee'];
    const client = getClient();
    const result = await client.calendarAttendee
      .create({
        data: {
