...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<InteractionSelect, InteractionFilter, InteractionOrderBy> & {
    ...
    const result = await client.interaction.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<InteractionSelect, InteractionFilter, InteractionOrderBy> & {
        select: InteractionSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.interaction.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
