...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<ContactAddressSelect, ContactAddressFilter, ContactAddressOrderBy> & {
        select: ContactAddressSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.contactAddress.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<ContactAddressSelect, ContactAddressFilter, ContactAddressOrderBy> & {
        select: ContactAddressSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.contactAddress.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
