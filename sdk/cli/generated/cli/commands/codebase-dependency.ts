/**
 * CLI commands for CodebaseDependency
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const result = await client.codebaseDependency.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<CodebaseDependencySelect, CodebaseDependencyFilter, never> & {
        select: CodebaseDependencySelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.codebaseDependency.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateCodebaseDependencyInput['codebaseDependency'];
    const client = getClient();
    const result = await client.codebaseDependency
      .create({
        data: {
