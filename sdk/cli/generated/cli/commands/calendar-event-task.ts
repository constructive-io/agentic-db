/**
 * CLI commands for CalendarEventTask
...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const result = await client.calendarEventTask.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<CalendarEventTaskSelect, CalendarEventTaskFilter, CalendarEventTaskOrderBy> & {
        select: CalendarEventTaskSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.calendarEventTask.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(
      answers,
      fieldSchema
    ) as CreateCalendarEventTaskInput['calendarEventTask'];
    const client = getClient();
    const result = await client.calendarEventTask
      .create({
        data: {
