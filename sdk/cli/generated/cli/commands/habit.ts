...
import type { CreateHabitInput, HabitPatch } from '../../orm/input-types';
    ...
    const result = await client.habit
      .create({
        data: {
          ...
          targetCount: cleanedData.targetCount,
          currentStreak: cleanedData.currentStreak,
          bestStreak: cleanedData.bestStreak,
