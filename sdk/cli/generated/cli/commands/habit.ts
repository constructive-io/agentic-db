...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<HabitSelect, HabitFilter, HabitOrderBy> & {
        select: HabitSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.habit.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<HabitSelect, HabitFilter, HabitOrderBy> & {
        select: HabitSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.habit.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
...
async function handleCreate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const cleanedData = stripUndefined(answers, fieldSchema) as CreateHabitInput['habit'];
    const client = getClient();
    const result = await client.habit
      .create({
        data: {
          ...
          lastCompletedAt: cleanedData.lastCompletedAt,
...
async function handleUpdate(argv: Partial<Record<string, unknown>>, prompter: Inquirerer) {
  try {
    ...
    const answers = coerceAnswers(rawAnswers, fieldSchema);
    const cleanedData = stripUndefined(answers, fieldSchema) as HabitPatch;
    const client = getClient();
    const result = await client.habit
      .update({
        where: {
