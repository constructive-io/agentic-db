...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<CalendarSelect, CalendarFilter, CalendarOrderBy> & {
        select: CalendarSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.calendar.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<CalendarSelect, CalendarFilter, CalendarOrderBy> & {
        select: CalendarSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.calendar.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
