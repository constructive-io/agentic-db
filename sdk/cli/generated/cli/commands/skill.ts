    ...
    const result = await client.skill
      .findMany({
        select: {
          ...
          slugTrgmSimilarity: true,
          descriptionTrgmSimilarity: true,
          contentTrgmSimilarity: true,
          procedureTrgmSimilarity: true,
          filePathTrgmSimilarity: true,
          contentHashTrgmSimilarity: true,
          ...
          intentTriggerVectorDistance: true,
          searchScore: true,
        },
      })
      .execute();
    ...
    const result = await client.skill
      .create({
        data: {
          ...
          alwaysLoad: cleanedData.alwaysLoad,
