...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<CompanyImageSelect, CompanyImageFilter, never, CompanyImageOrderBy> & {
        select: CompanyImageSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.companyImage.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<CompanyImageSelect, CompanyImageFilter, never> & {
        select: CompanyImageSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.companyImage.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
