...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<MessageSelect, MessageFilter, MessageOrderBy> & {
    ...
    const result = await client.message.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<MessageSelect, MessageFilter, MessageOrderBy> & {
        select: MessageSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.message.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
    ...
    const result = await client.message
      .create({
        data: {
          ...
          tokenCount: cleanedData.tokenCount,
