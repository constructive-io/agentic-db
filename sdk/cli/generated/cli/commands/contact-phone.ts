...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<ContactPhoneSelect, ContactPhoneFilter, never, ContactPhoneOrderBy> & {
        select: ContactPhoneSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.contactPhone.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<ContactPhoneSelect, ContactPhoneFilter, never> & {
        select: ContactPhoneSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.contactPhone.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
