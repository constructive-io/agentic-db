    ...
    const result = await client.agent
      .findMany({
        select: {
          ...
          personaTrgmSimilarity: true,
          backstoryTrgmSimilarity: true,
          communicationStyleTrgmSimilarity: true,
          systemPromptTrgmSimilarity: true,
          preferredModelTrgmSimilarity: true,
          moodTrgmSimilarity: true,
          focusTrgmSimilarity: true,
