...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<HikingTrailSelect, HikingTrailFilter, never, HikingTrailOrderBy> & {
    ...
    const result = await client.hikingTrail.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<HikingTrailSelect, HikingTrailFilter, never> & {
        select: HikingTrailSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.hikingTrail.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
