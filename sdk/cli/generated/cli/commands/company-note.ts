...
async function handleList(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findManyArgs = parseFindManyArgs<
      FindManyArgs<CompanyNoteSelect, CompanyNoteFilter, never, CompanyNoteOrderBy> & {
        select: CompanyNoteSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.companyNote.findMany(findManyArgs).execute();
...
async function handleFindFirst(argv: Partial<Record<string, unknown>>, _prompter: Inquirerer) {
  try {
    ...
    const findFirstArgs = parseFindFirstArgs<
      FindFirstArgs<CompanyNoteSelect, CompanyNoteFilter, never> & {
        select: CompanyNoteSelect;
      }
    >(argv, defaultSelect);
    const client = getClient();
    const result = await client.companyNote.findFirst(findFirstArgs).execute();
    console.log(JSON.stringify(result, null, 2));
  } catch (error) {
