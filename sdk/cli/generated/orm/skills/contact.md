...
db.contact.create({ data: { entityId: '<value>', firstName: '<value>', lastName: '<value>', email: '<value>', phone: '<value>', headline: '<value>', bio: '<value>', location: '<value>' }, select: { id: true } }).execute()
...
const item = await db.contact.create({
  data: { entityId: 'value', firstName: 'value', lastName: 'value', email: 'value', phone: 'value', headline: 'value', bio: 'value', location: 'value' },
  select: { id: true }
}).execute();
```
