...
export interface AppProfileDefinitionGrant {
  id: string;
  /** References the profile whose definition was modified */
  profileId?: string | null;
  /** References the permission that was added to or removed from the profile */
...
export interface AppProfileGrant {
  id: string;
  /** References the membership that received or lost this profile */
