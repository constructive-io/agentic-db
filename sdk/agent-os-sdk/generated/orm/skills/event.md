...
db.event.create({ data: { entityId: '<value>', name: '<value>', eventType: '<value>', location: '<value>', city: '<value>', startedAt: '<value>', endedAt: '<value>', notes: '<value>' }, select: { id: true } }).execute()
...
const item = await db.event.create({
  data: { entityId: 'value', name: 'value', eventType: 'value', location: 'value', city: 'value', startedAt: 'value', endedAt: 'value', notes: 'value' },
  select: { id: true }
}).execute();
```
