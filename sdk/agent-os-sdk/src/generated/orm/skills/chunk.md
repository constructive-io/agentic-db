...
db.chunk.create({ data: { entityId: '<value>', content: '<value>', startLine: '<value>', endLine: '<value>', embedding: '<value>', fileId: '<value>', repositoryId: '<value>' }, select: { id: true } }).execute()
...
const item = await db.chunk.create({
  data: { entityId: 'value', content: 'value', startLine: 'value', endLine: 'value', embedding: 'value', fileId: 'value', repositoryId: 'value' },
  select: { id: true }
}).execute();
```
